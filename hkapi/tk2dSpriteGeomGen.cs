...
{
	// Token: 0x06001F64 RID: 8036 RVA: 0x0009C354 File Offset: 0x0009A554
	...
	// Token: 0x06001F65 RID: 8037 RVA: 0x0009C3B8 File Offset: 0x0009A5B8
	...
	// Token: 0x06001F66 RID: 8038 RVA: 0x0009C45C File Offset: 0x0009A65C
	...
	// Token: 0x06001F67 RID: 8039 RVA: 0x0009C474 File Offset: 0x0009A674
	...
	// Token: 0x06001F68 RID: 8040 RVA: 0x0009C54C File Offset: 0x0009A74C
	...
	// Token: 0x06001F69 RID: 8041 RVA: 0x0009C57B File Offset: 0x0009A77B
	...
	// Token: 0x06001F6A RID: 8042 RVA: 0x0009C598 File Offset: 0x0009A798
	public static void SetClippedSpriteGeom(Vector3[] pos, Vector2[] uv, int offset, out Vector3 boundsCenter, out Vector3 boundsExtents, tk2dSpriteDefinition spriteDef, Vector3 scale, Vector2 clipBottomLeft, Vector2 clipTopRight, float colliderOffsetZ, float colliderExtentZ)
	{
		...
		if (spriteDef.positions.Length == 4)
		{
			...
			if (spriteDef.flipped == tk2dSpriteDefinition.FlipMode.TPackerCW)
			{
	...
	// Token: 0x06001F6B RID: 8043 RVA: 0x0009CCC5 File Offset: 0x0009AEC5
	...
	// Token: 0x06001F6C RID: 8044 RVA: 0x0009CCFC File Offset: 0x0009AEFC
	...
	// Token: 0x06001F6D RID: 8045 RVA: 0x0009CD20 File Offset: 0x0009AF20
	...
	// Token: 0x06001F6E RID: 8046 RVA: 0x0009D1A0 File Offset: 0x0009B3A0
	...
	// Token: 0x06001F6F RID: 8047 RVA: 0x0009D1F0 File Offset: 0x0009B3F0
	...
	// Token: 0x06001F70 RID: 8048 RVA: 0x0009D264 File Offset: 0x0009B464
		...
		for (int i = 0; i < num2; i++)
		{
			...
			for (int j = 0; j < num; j++)
			{
				...
				if (num4 != 1f || num5 != 1f)
				{
					...
					pos[offset + num3] = a + new Vector3(vector8.x, vector8.y, vector8.z);
					pos[offset + num3 + 1] = a + new Vector3(vector9.x, vector8.y, vector8.z);
					pos[offset + num3 + 2] = a + new Vector3(vector8.x, vector9.y, vector8.z);
					pos[offset + num3 + 3] = a + new Vector3(vector9.x, vector9.y, vector8.z);
					if (spriteDef.flipped == tk2dSpriteDefinition.FlipMode.Tk2d)
					{
				...
				{
					pos[offset + num3] = a + Vector3.Scale(spriteDef.positions[0], scale);
					pos[offset + num3 + 1] = a + Vector3.Scale(spriteDef.positions[1], scale);
					pos[offset + num3 + 2] = a + Vector3.Scale(spriteDef.positions[2], scale);
					pos[offset + num3 + 3] = a + Vector3.Scale(spriteDef.positions[3], scale);
	...
	// Token: 0x06001F71 RID: 8049 RVA: 0x0009DC78 File Offset: 0x0009BE78
	...
	// Token: 0x06001F72 RID: 8050 RVA: 0x0009DD14 File Offset: 0x0009BF14
	public static void SetBoxMeshData(Vector3[] pos, int[] indices, int posOffset, int indicesOffset, int vStart, Vector3 origin, Vector3 extents, Matrix4x4 mat, Vector3 baseScale)
	{
		...
		int[] array = (mat.m00 * mat.m11 * mat.m22 * baseScale.x * baseScale.y * baseScale.z >= 0f) ? tk2dSpriteGeomGen.boxIndicesFwd : tk2dSpriteGeomGen.boxIndicesBack;
	...
	// Token: 0x06001F73 RID: 8051 RVA: 0x0009DE48 File Offset: 0x0009C048
	...
	// Token: 0x06001F74 RID: 8052 RVA: 0x0009DEDC File Offset: 0x0009C0DC
	...
	// Token: 0x06001F75 RID: 8053 RVA: 0x0009E02C File Offset: 0x0009C22C
	// Note: this type is marked as 'beforefieldinit'.
	static tk2dSpriteGeomGen()
	{
		tk2dSpriteGeomGen.boxIndicesBack = new int[]
		{
			0,
			1,
			2,
		...
		tk2dSpriteGeomGen.boxIndicesFwd = new int[]
		{
			2,
			1,
			0,
		...
		tk2dSpriteGeomGen.boxUnitVertices = new Vector3[]
		{
		...
		tk2dSpriteGeomGen.boxScaleMatrix = Matrix4x4.identity;
	}
