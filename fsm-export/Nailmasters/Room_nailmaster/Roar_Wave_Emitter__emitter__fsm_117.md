...
| --- | --- |
| FSM Name | emitter |
| GameObject Name | Roar Wave Emitter |
| GameObject Path |  |
| Source Asset | /home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets13.assets |
| Start State | Init |
| FSM PathId | 117 |
...
| sendEvent | "CLOSE INVENTORY" | "CLOSE INVENTORY" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| storeResult | GameObject Rubble | GameObject Rubble | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Rubble | OwnerDefault Rubble |  |  |
...
| --- | --- | --- | --- | --- |
| eventTarget | EventTarget(BroadcastAll):FSM Owner | EventTarget(BroadcastAll):FSM Owner |  |  |
| sendEvent | "ROAR WAVE START" | "ROAR WAVE START" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| Emit Start | END | End | 0 | 0 | 0 |
| Finish Lines | FINISHED | Emit | 0 | 0 | 0 |
| Finish Lines | END | End | 0 | 0 | 0 |
| End | FINISHED | Destroy | 0 | 0 | 0 |
| Pause | FINISHED | Emit Start | 0 | 0 | 0 |
| Pause | END | End | 0 | 0 | 0 |
