...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Enter Delay | 1 | Single: 1 |
| Enter Transition Time | 2 | Single: 2 |
| Enter Transition Time Init | 0 | Single: 0 |
| Exit Transition Time | 5 | Single: 5 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Enter Track Event | QUEEN | String: QUEEN |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Enter Music Cue | [Queen (Script MusicCue) (Hollow Knight/hollow_knight_Data\sharedassets348.assets)] | NamedAssetPPtr: [Queen (Script MusicCue) (Hollow Knight/hollow_knight_Data\sharedassets348.assets)] |
| Enter Music Snapshot | [Normal (AudioMixerSnapshotController) (Hollow Knight/hollow_knight_Data\resources.assets)] | NamedAssetPPtr: [Normal (AudioMixerSnapshotController) (Hollow Knight/hollow_knight_Data\resources.assets)] |
| Exit Music Cue | [null] | NamedAssetPPtr: [null] |
| Exit Music Snapshot | [Silent (AudioMixerSnapshotController) (Hollow Knight/hollow_knight_Data\resources.assets)] | NamedAssetPPtr: [Silent (AudioMixerSnapshotController) (Hollow Knight/hollow_knight_Data\resources.assets)] |
...
| --- | --- | --- | --- | --- |
| snapshot |   | object Enter Music Snapshot = [Normal (AudioMixerSnapshotController) (Hollow Knight/hollow_knight_Data\resources.assets)] |   |   |
| transitionTime |   | float Enter Transition Time Init |   |   |
