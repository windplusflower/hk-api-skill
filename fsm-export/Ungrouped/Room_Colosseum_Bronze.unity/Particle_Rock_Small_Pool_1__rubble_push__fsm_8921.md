...
| GameObject Name | Particle Rock Small Pool 1 |
...
| min |   | -100f |   |   |
| max |   | 100f |   |   |
| storeResult |   | float Chooser X | Variable |   |
...
| min |   | -50f |   |   |
| max |   | 50f |   |   |
| storeResult |   | float Chooser Torque | Variable |   |
...
| min |   | 0f |   |   |
| max |   | 40f |   |   |
| storeResult |   | float Chooser Y | Variable |   |
