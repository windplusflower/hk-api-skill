...
| GameObject Name | Start Blanker |
| GameObject Path | _GameCameras/CameraParent/tk2dCamera/ |
...
| variableName |   | "Blanker" | FsmGameObject |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| fromValue |   | Color Start Colour |   |   |
| toValue |   | Color End Colour |   |   |
| colorVariable |   | Color Colour | Variable |   |
| time |   | 2.3f |   |   |
| speed |   | 0f |   |   |
| delay |   | 0f |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| fromValue |   | Color End Colour |   |   |
| toValue |   | Color Start Colour |   |   |
| colorVariable |   | Color Colour | Variable |   |
| time |   | 1.5f |   |   |
| speed |   | 0f |   |   |
| delay |   | 0f |   |   |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| START FADE OUT | Idle | 0 | |
| HIDE START BLANKER | Hide | 0 | |
...
| FADE OUT | false |
| FINISHED | false |
| HIDE START BLANKER | false |
| LEVEL LOADED | false |
| OUT | false |
| START FADE | false |
| START FADE OUT | false |
