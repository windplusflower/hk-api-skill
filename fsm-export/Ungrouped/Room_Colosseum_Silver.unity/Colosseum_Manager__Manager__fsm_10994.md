...
| Remasker | [null] | NamedAssetPPtr: [null] |
...
| childName |   | "Area Title Controller" |   |   |
...
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Remasker" |   |   |
| storeResult |   | GameObject Remasker | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Remasker |   |   |
| activate |   | true |   |   |
| recursive |   | false |   |   |
| resetOnExit |   | false |   |   |
| everyFrame |   | false |   |   |
...
| audioClip |   | [gate_slam (AudioClip) (Hollow Knight/hollow_knight_Data\sharedassets30.assets)] |   |   |
| pitchMin |   | 0.85f |   |   |
| pitchMax |   | 0.85f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | GameObject Walls | Variable |   |
| activate |   | true |   |   |
...
| boolName |   | "seenColosseumTitle" |   |   |
| isTrue |   | Event() |   |   |
| isFalse |   | Event(FIRST TITLE) |   |   |
...
| FIRST TITLE | Extra Title Pause | 0 | |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| WAVES COMPLETED | Reward Antic | 0 | |
