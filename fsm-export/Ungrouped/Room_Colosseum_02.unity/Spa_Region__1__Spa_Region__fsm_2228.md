...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Glow Front | Spa Region (1)/Spa Glows Front (Hollow Knight/hollow_knight_Data\level31) | NamedAssetPPtr: [Spa Region (1)/Spa Glows Front (Hollow Knight/hollow_knight_Data\level31)] |
| Glows | Spa Region (1)/Spa Glows (Hollow Knight/hollow_knight_Data\level31) | NamedAssetPPtr: [Spa Region (1)/Spa Glows (Hollow Knight/hollow_knight_Data\level31)] |
...
| Steam | Spa Region (1)/Spa Steam (Hollow Knight/hollow_knight_Data\level31) | NamedAssetPPtr: [Spa Region (1)/Spa Steam (Hollow Knight/hollow_knight_Data\level31)] |
