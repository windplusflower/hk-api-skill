...
| Intro Msg Bool | metSlyShop | String: metSlyShop |
| Intro Msg Convo | SLY_SHOP_INTRO | String: SLY_SHOP_INTRO |
| Intro Msg Sheet | Sly | String: Sly |
| NPC Title | SLY | String: SLY |
