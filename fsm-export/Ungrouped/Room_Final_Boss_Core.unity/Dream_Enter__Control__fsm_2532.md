...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Return Scene | none | String: none |
| To Scene | Dream_Final_Boss | String: Dream_Final_Boss |
...
| value |   | string Return Scene = "none" |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| sceneName |   | string To Scene = "Dream_Final_Boss" |   |   |
| entryGateName |   | "door1" |   |   |
| entryDelay |   | 0f |   |   |
