...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Player Data | openedTownBuilding | String: openedTownBuilding |
...
| Target | Station Door (Hollow Knight/hollow_knight_Data\level9) | NamedAssetPPtr: [Station Door (Hollow Knight/hollow_knight_Data\level9)] |
