...
| --- | --- |
| FSM Name | Control |
| GameObject Name | Dream Enter Grimm |
| GameObject Path |   |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Return Scene | Grimm_Main_Tent | String: Grimm_Main_Tent |
| To Scene | Grimm_Nightmare | String: Grimm_Nightmare |
...
| value |   | string Return Scene = "Grimm_Main_Tent" |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| sceneName |   | string To Scene = "Grimm_Nightmare" |   |   |
| entryGateName |   | "door1" |   |   |
| entryDelay |   | 0f |   |   |
| visualization |   | Enum(GameManager+SceneLoadVisualizations, 3) |   |   |
