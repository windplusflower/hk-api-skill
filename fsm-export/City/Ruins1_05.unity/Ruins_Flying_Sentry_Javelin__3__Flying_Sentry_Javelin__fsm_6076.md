...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Charge Javelin Hit | Ruins Flying Sentry Javelin (3)/Charge Javelin Hit (Hollow Knight/hollow_knight_Data\level92) | NamedAssetPPtr: [Ruins Flying Sentry Javelin (3)/Charge Javelin Hit (Hollow Knight/hollow_knight_Data\level92)] |
