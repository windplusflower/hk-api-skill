...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Charge Javelin Hit | Ruins Flying Sentry Javelin (1)/Charge Javelin Hit (Hollow Knight/hollow_knight_Data\level97) | NamedAssetPPtr: [Ruins Flying Sentry Javelin (1)/Charge Javelin Hit (Hollow Knight/hollow_knight_Data\level97)] |
