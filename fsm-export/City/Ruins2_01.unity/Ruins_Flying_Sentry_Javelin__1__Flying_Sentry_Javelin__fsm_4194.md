...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Charge Javelin Hit | Battle Scene/Ruins Flying Sentry Javelin (1)/Charge Javelin Hit (Hollow Knight/hollow_knight_Data\level111) | NamedAssetPPtr: [Battle Scene/Ruins Flying Sentry Javelin (1)/Charge Javelin Hit (Hollow Knight/hollow_knight_Data\level111)] |
