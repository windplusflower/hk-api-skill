...
| Waited | false | Boolean: false |

### Strings

| Name | Value | Raw/Type |
| --- | --- | --- |
| Charge Anim | Charge2 | String: Charge2 |
| ChargeEnd Anim | ChargeEnd2 | String: ChargeEnd2 |
| Turn Anim | Turn2 | String: Turn2 |
| Walk Anim | Walk2 | String: Walk2 |
...
| Spawn Range | [null] | NamedAssetPPtr: [null] |
...
| storeResult |   | GameObject Spawn Range | Variable |   |
...
| gameObject |   | OwnerDefault FSM Owner |   |   |
| animLibName |   | "" |   |   |
| clipName |   | string Walk Anim = "Walk2" |   |   |
...
| groundLayer |   | "Terrain" |   |   |
| turnDelay |   | 0.5 |   |   |
| walkAnimName |   | string Walk Anim = "Walk2" |   |   |
| turnAnimName |   | string Turn Anim = "Turn2" |   |   |
| startLeft |   | false |   |   |
| startRight |   | false |   |   |
| keepDirection |   | true |   |   |
...
| greaterThanBool |   | bool Waited | Variable |   |
| everyFrame |   | true |   |   |
...
| topHitEvent |   | Event() |   |   |
| rightHitEvent |   | Event(COLLIDE) |   |   |
| bottomHitEvent |   | Event() |   |   |
| leftHitEvent |   | Event(COLLIDE) |   |   |
| otherLayer |   | false |   |   |
| otherLayerNumber |   | 0 |   |   |
...
| storeDidHit |   | bool Ground Detected | Variable |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| clipName |   | string ChargeEnd Anim |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Spawn Range |   |   |
| activate |   | false |   |   |
| recursive |   | false |   |   |
| resetOnExit |   | false |   |   |
| everyFrame |   | false |   |   |
