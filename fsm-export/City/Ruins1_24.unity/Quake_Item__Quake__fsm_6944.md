...
| --- | --- |
| FSM Name | Quake |
| GameObject Name | Quake Item |
| GameObject Path | Quake Real Parent/Quake Pickup/ |
| Source Asset | D:/SteamLibrary/steamapps/common/Hollow Knight/hollow_knight_Data/level101 |
| Start State | Pause |
| FSM PathId | 6944 |
| GameObject PathId | 1254 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Fireball Getter | [null] | NamedAssetPPtr: [null] |
...
Full Name: HutongGames.PlayMaker.Actions.GetGrandparent
Enabled: true
...
| childName |   | "Knight Get Quake" |   |   |
| storeResult |   | GameObject Fireball Getter | Variable |   |

##### 14. SetPositionToObject
...
| targetObject |   | GameObject Hero Object |   |   |
| xOffset |   | 0f |   |   |
| yOffset |   | -0.5f |   |   |
| zOffset |   | 0f |   |   |
...
| sendEvent |   | "ACTIVATE BATTLE ROOF" |   |   |
| delay |   | 0f |   |   |
| everyFrame |   | false |   |   |
