...
| --- | --- |
| FSM Name | Control |
| GameObject Name | Roof Collider Battle |
| GameObject Path |   |
...
| --- | --- | --- | --- |
| MAGE WINDOW BREAK | Check Hero Y | 0 | |
| ACTIVATE BATTLE ROOF | Check Hero Y | 0 | |
