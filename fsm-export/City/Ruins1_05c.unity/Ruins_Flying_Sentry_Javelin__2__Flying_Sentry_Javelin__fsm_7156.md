...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Charge Javelin Hit | Ruins Flying Sentry Javelin (2)/Charge Javelin Hit (Hollow Knight/hollow_knight_Data\level94) | NamedAssetPPtr: [Ruins Flying Sentry Javelin (2)/Charge Javelin Hit (Hollow Knight/hollow_knight_Data\level94)] |
