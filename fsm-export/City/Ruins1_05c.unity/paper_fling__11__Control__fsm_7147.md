...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Audio Clip | [null] | NamedAssetPPtr: [null] |
...
| audioClip |   | object Audio Clip |   |   |
| pitchMin |   | float Pitch Min |   |   |
| pitchMax |   | float Pitch Max |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
| storePlayer |   |   |   |   |
