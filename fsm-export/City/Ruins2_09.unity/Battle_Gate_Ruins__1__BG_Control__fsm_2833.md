...
| --- | --- |
| FSM Name | BG Control |
| GameObject Name | Battle Gate Ruins (1) |
| GameObject Path |   |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Raise Dust | Battle Gate Ruins (1)/Raise Dust (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level121) | NamedAssetPPtr: [Battle Gate Ruins (1)/Raise Dust (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level121)] |
