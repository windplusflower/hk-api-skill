...
| --- | --- |
| FSM Name | Control |
| GameObject Name | Hiveling Spawner (3) |
| GameObject Path | Hatcher Cage (1)/ |
...
| Owner | [null] | NamedAssetPPtr: [null] |
| Owner | [null] | NamedAssetPPtr: [null] |
| Pt Death | [null] | NamedAssetPPtr: [null] |
...
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Pt Death" |   |   |
| storeResult |   | GameObject Pt Death | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Owner |   |   |
| fsmName |   | "Zombie Hive" | FsmName |   |
| variableName |   | "Spawned" | FsmInt |   |
| storeValue |   | int Spawned | Variable |   |
| everyFrame |   | false |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Pt Death |   |   |
| emit |   | 0 |   |   |
