...
| --- | --- |
| FSM Name | FSM |
| GameObject Name | TerrainBackHigh |
| GameObject Path | Zombie Hive (3)/ |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Bool Name | Terrain Back High | String: Terrain Back High |
| FSM Name | Hive Zombie | String: Hive Zombie |
