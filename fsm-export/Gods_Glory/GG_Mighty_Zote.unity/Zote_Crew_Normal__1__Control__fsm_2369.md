...
| --- | --- |
| FSM Name | Control |
| GameObject Name | Zote Crew Normal (1) |
| GameObject Path | Battle Control/Dormant Warriors/ |
...
| Multiplier Low | 0.200000003 | Single: 0.200000003 |
| Prev X Speed | 9 | Single: 9 |
| Run Accel | 6 | Single: 6 |
| Run Speed | 3 | Single: 3 |
| Run Time Max | 1.25 | Single: 1.25 |
| Run Time Min | 0.75 | Single: 0.75 |
| Tripped Time Max | 15 | Single: 15 |
| Tripped Time Min | 0 | Single: 0 |
| Wall Hit Force | 0 | Single: 0 |
| X Pos | 0 | Single: 0 |
| X Speed | 0 | Single: 0 |
