...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Angry Loop | Fat Fluke (3)/Angry Loop (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (3)/Angry Loop (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458)] |
| Charge Loop | Fat Fluke (3)/Charge Loop (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (3)/Charge Loop (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458)] |
| Charge Loop 2 | Fat Fluke (3)/Charge Loop 2 (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (3)/Charge Loop 2 (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458)] |
| Crawl Loop | Fat Fluke (3)/Crawl Loop (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (3)/Crawl Loop (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458)] |
| Pt Spatter | Fat Fluke (3)/Pt Spatter (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (3)/Pt Spatter (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level458)] |
