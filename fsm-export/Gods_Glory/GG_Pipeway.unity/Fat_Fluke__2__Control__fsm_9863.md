...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Angry Loop | Fat Fluke (2)/Angry Loop (Hollow Knight/hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (2)/Angry Loop (Hollow Knight/hollow_knight_Data\level458)] |
| Charge Loop | Fat Fluke (2)/Charge Loop (Hollow Knight/hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (2)/Charge Loop (Hollow Knight/hollow_knight_Data\level458)] |
| Charge Loop 2 | Fat Fluke (2)/Charge Loop 2 (Hollow Knight/hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (2)/Charge Loop 2 (Hollow Knight/hollow_knight_Data\level458)] |
| Crawl Loop | Fat Fluke (2)/Crawl Loop (Hollow Knight/hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (2)/Crawl Loop (Hollow Knight/hollow_knight_Data\level458)] |
| Pt Spatter | Fat Fluke (2)/Pt Spatter (Hollow Knight/hollow_knight_Data\level458) | NamedAssetPPtr: [Fat Fluke (2)/Pt Spatter (Hollow Knight/hollow_knight_Data\level458)] |
