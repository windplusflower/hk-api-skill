...
| audioClip |   | [Gorb_battlecry (AudioClip) (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\sharedassets194.assets)] |   |   |
| pitchMin |   | 1f |   |   |
| pitchMax |   | 1f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| FINISHED | Is Hero Away? | 0 | |
| TOOK DAMAGE | Damaged | 0 | |
...
| min |   | 0f |   |   |
| max |   | 360f |   |   |
| storeResult |   | float Shot Angle | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| floatVariable |   | float Shot Angle | Variable |   |
| add |   | 45f |   |   |
| everyFrame |   | false |   |   |
| perSecond |   | false |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable |   | bool Hero Away | Variable |   |
| isTrue |   | Event(CANCEL) |   |   |
...
| floatVariable |   | float Float | Variable |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| floatVariable |   | float Float | Variable |   |
| intVariable |   | int Double HP | Variable |   |
...
| --- | --- | --- | --- | --- |
| floatVariable |   | float Float | Variable |   |
| intVariable |   | int Triple HP | Variable |   |
| rounding | HutongGames.PlayMaker.Actions.ConvertFloatToInt/FloatRounding::Nearest | 2 |   |   |
| everyFrame |   | false |   |   |
