...
| Move To X | 93.4000015 | Single: 93.4000015 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Acid Tear | [null] | NamedAssetPPtr: [null] |
...
| Pt Burst 2 | [null] | NamedAssetPPtr: [null] |
| Pt Sizzle | [null] | NamedAssetPPtr: [null] |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| objectName |   | "Acid Tear" |   |   |
| withTag |   | "Untagged" | Tag |   |
| store |   | GameObject Acid Tear | Variable |   |
...
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Pt Burst" |   |   |
| storeResult |   | GameObject Pt Burst | Variable |   |
...
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Pt Sizzle" |   |   |
| storeResult |   | GameObject Pt Sizzle | Variable |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Pt Burst 2" |   |   |
| storeResult |   | GameObject Pt Burst 2 | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Acid Tear |   |   |
| activate |   | false |   |   |
| recursive |   | false |   |   |
| resetOnExit |   | false |   |   |
| everyFrame |   | false |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Pt Sizzle |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Pt Burst |   |   |
| emit |   | 0 |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Pt Burst 2 |   |   |
| emit |   | 0 |   |   |
...
| sprite |   | [_0004_acid_armour (Sprite) (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\sharedassets362.assets)] |   |   |
