...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Alert range Obj | Battle Scene/Inflater (2)/Alert Range (Hollow Knight/hollow_knight_Data\level359) | NamedAssetPPtr: [Battle Scene/Inflater (2)/Alert Range (Hollow Knight/hollow_knight_Data\level359)] |
| Bouncer | Battle Scene/Inflater (2)/Bouncer (Hollow Knight/hollow_knight_Data\level359) | NamedAssetPPtr: [Battle Scene/Inflater (2)/Bouncer (Hollow Knight/hollow_knight_Data\level359)] |
| Damager | [null] | NamedAssetPPtr: [null] |
| Enemy Inflater | Battle Scene/Inflater (2)/Enemy Inflater (Hollow Knight/hollow_knight_Data\level359) | NamedAssetPPtr: [Battle Scene/Inflater (2)/Enemy Inflater (Hollow Knight/hollow_knight_Data\level359)] |
