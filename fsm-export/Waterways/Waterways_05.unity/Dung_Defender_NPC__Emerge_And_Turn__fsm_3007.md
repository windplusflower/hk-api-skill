...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Emerge Range | false | Boolean: false |
...
| --- | --- | --- | --- | --- |
| boolVariable |   | bool Emerge Range | Variable |   |
| isTrue |   | Event(WAKE) |   |   |
| isFalse |   | Event() |   |   |
| everyFrame |   | true |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Emerge Chunks |   |   |
| emit |   | 0 |   |   |
