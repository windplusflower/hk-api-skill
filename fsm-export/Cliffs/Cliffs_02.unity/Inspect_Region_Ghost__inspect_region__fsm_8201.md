...
| GameObject Path |   |
| Source Asset | D:/SteamLibrary/steamapps/common/Hollow Knight/hollow_knight_Data/level231 |
| Start State | Init |
| FSM PathId | 8201 |
| GameObject PathId | 1821 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Game Text Convo | ALADAR_INSPECT | String: ALADAR_INSPECT |
| Game Text Sheet | Ghosts | String: Ghosts |
