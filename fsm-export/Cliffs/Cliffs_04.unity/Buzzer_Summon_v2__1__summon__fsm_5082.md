...
| --- | --- |
| FSM Name | summon |
| GameObject Name | Buzzer Summon v2 (1) |
| GameObject Path | Summon 1 (2)/ |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Buzzer |   |   |
| fsmName |   | "chaser" | FsmName |   |
| variableName |   | "Start Alert" | FsmBool |   |
| setValue |   | true |   |   |
| everyFrame |   | false |   |   |
