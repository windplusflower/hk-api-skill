...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Cutscene | OwnerDefault Cutscene |  |  |
...
| methodName | "ResetQuakeDamage" | "ResetQuakeDamage" | Method |  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| childName | "Knight Dream Arrival" | "Knight Dream Arrival" |  |  |
| storeResult | GameObject Cutscene | GameObject Cutscene | Variable |  |
...
| --- | --- | --- | --- | --- |
| trueEvent | Event() | Event() |  |  |
| falseEvent | Event(STATUE) | Event(STATUE) |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| trueEvent | Event(FIRST) | Event(FIRST) |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Take Control | FINISHED | First Boss? 1 | 0 | 0 | 0 |
| Start Fade | FINISHED | First Boss? | 0 | 0 | 0 |
| Pause | FINISHED | Door Entry | 0 | 0 | 0 |
| Door Entry | ACTIVATE | Take Control | 0 | 0 | 0 |
| Wait for Anim | FINISHED | Return Control | 0 | 0 | 0 |
| Arrive Anim | FINISHED | Wait for Anim | 0 | 0 | 0 |
| First Boss? | TRUE | Arrive Anim | 0 | 0 | 0 |
| First Boss? | FALSE | Return from Kneeling | 0 | 0 | 0 |
| First Boss? 1 | FINISHED | Start Kneeling | 0 | 0 | 0 |
| First Boss? 1 | FIRST | Hide Player | 0 | 0 | 0 |
| First Boss? 1 | STATUE | Statue | 0 | 0 | 0 |
| Start Kneeling | FINISHED | Pause Kneeling | 0 | 0 | 0 |
| Hide Player | FINISHED | Start Fade | 0 | 0 | 0 |
| Return from Kneeling | FINISHED | Return Control | 0 | 0 | 0 |
| Return from Kneeling | KNIGHT EXITED ROAR | Return Control | 0 | 0 | 0 |
| Pause Kneeling | FINISHED | Wait for Transition | 0 | 0 | 0 |
| Wait for Transition | FINISHED | Start Fade | 0 | 0 | 0 |
| Statue | FINISHED | Start Kneeling | 0 | 0 | 0 |
