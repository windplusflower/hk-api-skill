...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| variableName | "BOSSRUSH_END_SCENE" | "BOSSRUSH_END_SCENE" |  |  |
| storeValue | Var End Scene =  | Var End Scene =  | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| sceneName | string End Scene | string End Scene |  |  |
| entryGateName | "" | "" |  |  |
| entryDelay | 0f | 0f |  |  |
| visualization | Enum(GameManager+SceneLoadVisualizations, 5) | Enum(GameManager+SceneLoadVisualizations, 5) |  |  |
| preventCameraFadeOut | false | false |  |  |

## Transitions

| From | Event | To | ColorIndex | LinkStyle | LinkConstraint |
| --- | --- | --- | --- | --- | --- |
| Start | FINISHED | Wait | 0 | 0 | 0 |
| End | FINISHED | Next Scene | 0 | 0 | 0 |
| Wait | FINISHED | Fade | 0 | 0 | 0 |
| Fade | FINISHED | Next Scene | 0 | 0 | 0 |
