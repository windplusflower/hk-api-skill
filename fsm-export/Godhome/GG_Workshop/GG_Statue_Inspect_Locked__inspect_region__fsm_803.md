...
| Centre Centre | true | Boolean: true |
| Centre Top | false | Boolean: false |
...
| Hero Looks Up | false | Boolean: false |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Game Text Convo | GG_LOCKED_DESC_GRUZ | String: GG_LOCKED_DESC_GRUZ |
| Game Text Sheet | CP3 | String: CP3 |
...
| sendEvent | "INSPECT END" | "INSPECT END" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Hero Looks Up | bool Hero Looks Up | Variable |  |
| isTrue | Event() | Event() |  |  |
...
| sendEvent | "DO INSPECT" | "DO INSPECT" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Centre Centre | bool Centre Centre | Variable |  |
| isTrue | Event(CENTRE) | Event(CENTRE) |  |  |
| isFalse | Event() | Event() |  |  |
| everyFrame | false | false |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Centre Top | bool Centre Top | Variable |  |
| isTrue | Event(CENTRE TOP) | Event(CENTRE TOP) |  |  |
| isFalse | Event() | Event() |  |  |
| everyFrame | false | false |  |  |
...
| Convo End | FINISHED | Pause | 0 | 0 | 0 |
| Pause | FINISHED | Idle | 0 | 0 | 0 |
| Check Proximity | MOVE RIGHT | Move Hero Right | 0 | 0 | 0 |
| Check Proximity | FINISHED | Hero Look Up? | 0 | 0 | 0 |
...
| Move Hero Right | HERO DAMAGED | Convo End | 0 | 0 | 0 |
| Take Control | FINISHED | Check Proximity | 0 | 0 | 0 |
| Turn Hero Left | FINISHED | Hero Look Up? | 0 | 0 | 0 |
| Turn Hero Left | HERO DAMAGED | Convo End | 0 | 0 | 0 |
| Move Hero Left | FINISHED | Turn Hero Right | 0 | 0 | 0 |
| Move Hero Left | HERO DAMAGED | Convo End | 0 | 0 | 0 |
| Turn Hero Right | FINISHED | Hero Look Up? | 0 | 0 | 0 |
| Turn Hero Right | HERO DAMAGED | Convo End | 0 | 0 | 0 |
| Inert | BIG TITLE END | Idle | 0 | 0 | 0 |
| Can Talk Bool? | TRUE | In Range | 0 | 0 | 0 |
| Can Talk Bool? | FALSE | Idle | 0 | 0 | 0 |
| Box Down | FINISHED | Convo End | 0 | 0 | 0 |
| Box Down | HERO DAMAGED | Convo End | 0 | 0 | 0 |
| Box Up | FINISHED | Read | 0 | 0 | 0 |
| Box Up | HERO DAMAGED | Cancel | 0 | 0 | 0 |
| Look Up End? | FINISHED | Box Down | 0 | 0 | 0 |
| Read | CONVO_FINISH | Look Up End? | 0 | 0 | 0 |
| Read | HERO DAMAGED | Cancel | 0 | 0 | 0 |
| Hero Look Up? | FINISHED | Centre? | 0 | 0 | 0 |
| Hero Look Up? | HERO DAMAGED | Convo End | 0 | 0 | 0 |
| Cancel | FINISHED | Convo End | 0 | 0 | 0 |
| Centre? | CENTRE | Centre | 0 | 0 | 0 |
| Centre? | CENTRE TOP | Top Centre | 0 | 0 | 0 |
| Centre? | FINISHED | Box Up | 0 | 0 | 0 |
| Centre | FINISHED | Box Up | 0 | 0 | 0 |
| Top Centre | FINISHED | Box Up | 0 | 0 | 0 |
