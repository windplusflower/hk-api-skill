...
| --- | --- |
| FSM Name | Corpse |
| GameObject Name | Corpse Mantis Lord |
| GameObject Path |  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| clipName | "Death New 2" | "Death New 2" |  |  |
...
| sendEvent | "MANTIS DEFEATED" | "MANTIS DEFEATED" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Init | FINISHED | Stop Effect | 0 | 0 | 0 |
| Depart | FINISHED | Leave Pause | 0 | 0 | 0 |
| Leave Pause | FINISHED | Destroy | 0 | 0 | 0 |
| Stop Effect | FINISHED | Depart | 0 | 0 | 0 |
