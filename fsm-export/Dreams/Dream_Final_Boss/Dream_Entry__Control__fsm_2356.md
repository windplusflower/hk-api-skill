...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Hero Faces left | bool Hero Faces left | Variable |  |
| isTrue | Event(L) | Event(L) |  |  |
| isFalse | Event(R) | Event(R) |  |  |
| everyFrame | false | false |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Take Control | FINISHED | Facing | 0 | 0 | 0 |
| Start Fade | FINISHED | Arrive Anim | 0 | 0 | 0 |
| Arrive Anim | FINISHED | Wait for Anim | 0 | 0 | 0 |
| Facing | L | Left | 0 | 0 | 0 |
| Facing | R | Right | 0 | 0 | 0 |
| Left | FINISHED | Start Fade | 0 | 0 | 0 |
| Right | FINISHED | Start Fade | 0 | 0 | 0 |
