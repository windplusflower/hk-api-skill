...
| --- | --- |
| FSM Name | corpse |
| GameObject Name | Corpse Infected Knight Dream |
| GameObject Path |  |
...
| Corpse Steam | Corpse Infected Knight Dream/Corpse Steam (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets397.assets) | NamedAssetPPtr: Corpse Infected Knight Dream/Corpse Steam (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets397.assets) |
...
| functionCall | StoryRecord_defeated("Lost Kin") | StoryRecord_defeated("Lost Kin") |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolName | "infectedKnightDreamDefeated" | "infectedKnightDreamDefeated" |  |  |
| value | true | true |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Init | LAND | Stop Music | 0 | 0 | 0 |
| Steam | FINISHED | Ready | 0 | 0 | 0 |
| Blow | FINISHED | BG Open | 0 | 0 | 0 |
| Ready | FINISHED | Set Defeated | 0 | 0 | 0 |
| Pause | FINISHED | Steam | 0 | 0 | 0 |
| Item | FINISHED | BG Open | 0 | 0 | 0 |
| BG Open | FINISHED | State 1 | 0 | 0 | 0 |
| Stop Music | FINISHED | Pause | 0 | 0 | 0 |
| Set Defeated | FINISHED | Blow | 0 | 0 | 0 |
