...
| GameObject Path |  |
| Source Asset | /home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets270.assets |
| Start State | Idle |
| FSM PathId | 28 |
| GameObject PathId |  |
...
| min | -2f | -2f |  |  |
| max | 2f | 2f |  |  |
| storeResult | float X Speed | float X Speed | Variable |  |
...
| min | -1f | -1f |  |  |
| max | 5f | 5f |  |  |
| storeResult | float Y Speed | float Y Speed | Variable |  |
...
| torque | float Rotation | float Rotation |  |  |
| everyFrame | false | false |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Idle | SUPERDASH BLAST | Fall | 0 | 0 | 0 |
