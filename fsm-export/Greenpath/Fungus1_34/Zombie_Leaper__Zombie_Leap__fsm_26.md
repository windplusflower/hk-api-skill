...
| GameObject Path |  |
| Source Asset | /home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets160.assets |
...
| childName | "Land Dust" | "Land Dust" |  |  |
| storeResult | GameObject Land Dust | GameObject Land Dust | Variable |  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Self | OwnerDefault Self |  |  |
| animationTriggerEvent | Event(WAIT) | Event(WAIT) |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| floatVariable | float Jump X Speed | float Jump X Speed | Variable |  |
...
| gameObject | OwnerDefault Self | OwnerDefault Self |  |  |
| vector | Vector2(0, 0) | Vector2(0, 0) |  |  |
| x | float Jump X Speed | float Jump X Speed |  |  |
| y | 20f | 20f |  |  |
| everyFrame | false | false |  |  |
...
| Anticipate | WAIT | Launch | 0 | 0 | 0 |
| Left or Right? | HERO IS RIGHT | Face Right | 0 | 0 | 0 |
| Left or Right? | HERO IS LEFT | Face Left | 0 | 0 | 0 |
| Face Left | FINISHED | Anticipate | 0 | 0 | 0 |
| Face Right | FINISHED | Anticipate | 0 | 0 | 0 |
| Lunge | LAND | Cooldown | 0 | 0 | 0 |
| Cooldown | WAIT | Idle | 0 | 0 | 0 |
| Idle | WAIT | Reset | 0 | 0 | 0 |
| Reset | FINISHED | Ready | 0 | 0 | 0 |
| Launch | FINISHED | Lunge | 0 | 0 | 0 |
