...
| --- | --- |
| FSM Name | Control |
| GameObject Name | Shot Slug Spear |
| GameObject Path |  |
...
| angle | float Shot Angle | float Shot Angle |  |  |
| speed | 25f | 25f |  |  |
...
| zAngle | float Shot Angle | float Shot Angle | Variable |  |
...
| --- | --- | --- | --- | --- | --- |
| Fire | FINISHED | Dissipate | 0 | 0 | 0 |
| Pause | FINISHED | Poke Out | 0 | 0 | 0 |
| Poke Out | FINISHED | Fire | 0 | 0 | 0 |
