...
| timeMin | 3f | 3f |  |  |
| timeMax | 6f | 6f |  |  |
| finishEvent | Event(CRY) | Event(CRY) |  |  |
...
| newAnimationClip | "Cry Turn" | "Cry Turn" |  |  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| childName | "Grub Mimic" | "Grub Mimic" |  |  |
| storeResult | GameObject Mimic | GameObject Mimic | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Mimic | OwnerDefault Mimic |  |  |
| activate | true | true |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | GameObject Mimic | GameObject Mimic | Variable |  |
| isNull | Event(ACTIVATE) | Event(ACTIVATE) |  |  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| clipName | "Freed Fake" | "Freed Fake" |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Idle | ENTER | Hero Close | 0 | 0 | 0 |
| Idle | FREE | Free | 0 | 0 | 0 |
| Idle | CRY | Cry | 0 | 0 | 0 |
| Hero Close | EXIT | Sad Wait | 0 | 0 | 0 |
| Hero Close | FREE | Free | 0 | 0 | 0 |
| Init | FINISHED | Idle | 0 | 0 | 0 |
| Init | ACTIVATE | Activate | 0 | 0 | 0 |
| Free | FINISHED | Instant Trans? | 0 | 0 | 0 |
| Sad Sound | FINISHED | Idle Wait | 0 | 0 | 0 |
| Sad Wait | FINISHED | Sad Sound | 0 | 0 | 0 |
| Idle Wait | FINISHED | Idle | 0 | 0 | 0 |
| Cry | FINISHED | Idle | 0 | 0 | 0 |
| Instant Trans? | TRANSFORM | Transform | 0 | 0 | 0 |
| Instant Trans? | CRY | Fake Cry | 0 | 0 | 0 |
| Transform | ACTIVATE | Set Active | 0 | 0 | 0 |
| Fake Cry | FINISHED | Transform | 0 | 0 | 0 |
| Idle No Bottle | ENTER | Free | 0 | 0 | 0 |
