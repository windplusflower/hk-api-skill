...
| GameObject Path |  |
| Source Asset | /home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets31.assets |
| Start State | Pause |
| FSM PathId | 263 |
| GameObject PathId |  |
...
| --- | --- | --- | --- | --- |
| floatVariable | float Pos X | float Pos X | Variable |  |
| minValue | float X Min | float X Min |  |  |
| maxValue | float X Max | float X Max |  |  |
| everyFrame | true | true |  |  |
...
| --- | --- | --- | --- | --- |
| floatVariable | float Pos Y | float Pos Y | Variable |  |
| minValue | float Y Min | float Y Min |  |  |
| maxValue | float Y Max | float Y Max |  |  |
| everyFrame | true | true |  |  |
