...
| GameObject Name | Colosseum Grass Hopper |
| GameObject Path |  |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Grass Trail | [null] | NamedAssetPPtr:  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Grass Trail | OwnerDefault Grass Trail |  |  |
| emissionRate | 0f | 0f |  |  |
...
| timeMin | 0.15f | 0.15f |  |  |
| timeMax | 0.25f | 0.25f |  |  |
| finishEvent | Event(JUMP) | Event(JUMP) |  |  |
...
| childName | "Grass Trail" | "Grass Trail" |  |  |
| storeResult | GameObject Grass Trail | GameObject Grass Trail | Variable |  |
...
| spawnPoint | GameObject Grass Trail | GameObject Grass Trail |  |  |
| audioClip | [grass_hopper_jump (AudioClip) (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets34.assets)] | [grass_hopper_jump (AudioClip) (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets34.assets)] |  |  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| storeAngle | float Sprite Rotation | float Sprite Rotation | Variable |  |
...
| xAngle | 0f | 0f |  |  |
| yAngle | 0f | 0f |  |  |
| zAngle | float Sprite Rotation | float Sprite Rotation |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Idle | JUMP | Jump Antic | 0 | 0 | 0 |
| Init | FINISHED | Jump | 0 | 0 | 0 |
| Jump Antic | FINISHED | Jump | 0 | 0 | 0 |
| Jump | FINISHED | In Air | 0 | 0 | 0 |
| In Air | RIGHT | Land Right | 0 | 0 | 0 |
| In Air | LEFT | Land Left | 0 | 0 | 0 |
| In Air | UP | Land Up | 0 | 0 | 0 |
| In Air | DOWN | Land Down | 0 | 0 | 0 |
| Land Right | FINISHED | Idle | 0 | 0 | 0 |
| Land Left | FINISHED | Idle | 0 | 0 | 0 |
| Land Down | FINISHED | Idle | 0 | 0 | 0 |
| Land Up | FINISHED | Idle | 0 | 0 | 0 |
