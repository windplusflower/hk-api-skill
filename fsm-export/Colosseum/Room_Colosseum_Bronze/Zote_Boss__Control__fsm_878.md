...
| Attack Voice | [null] | NamedAssetPPtr:  |
| Bonker | [null] | NamedAssetPPtr:  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| childName | "Bonker" | "Bonker" |  |  |
| storeResult | GameObject Bonker | GameObject Bonker | Variable |  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| childName | "Attack Voice" | "Attack Voice" |  |  |
| storeResult | GameObject Attack Voice | GameObject Attack Voice | Variable |  |
...
| x | float Prev X Speed | float Prev X Speed | Variable |  |
| y | 0f | 0f | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| floatVariable | float Prev X Speed | float Prev X Speed | Variable |  |
| floatValue | float X Speed | float X Speed |  |  |
...
| x | float Prev X Speed | float Prev X Speed |  |  |
| y | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Will Fall | bool Will Fall | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Bonker | OwnerDefault Bonker |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Roared | bool Roared | Variable |  |
| isTrue | Event(ROARED) | Event(ROARED) |  |  |
| isFalse | Event() | Event() |  |  |
| everyFrame | false | false |  |  |
...
| spawnPoint | GameObject Self | GameObject Self |  |  |
| audioClip | [Zote_battle_roar (AudioClip) (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets32.assets)] | [Zote_battle_roar (AudioClip) (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets32.assets)] |  |  |
| pitchMin | 1f | 1f |  |  |
| pitchMax | 1f | 1f |  |  |
| volume | 1f | 1f |  |  |
| delay | 0f | 0f |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| float1 | float Jump X | float Jump X |  |  |
| float2 | 0f | 0f |  |  |
| tolerance | 0f | 0f |  |  |
| equal | Event() | Event() |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Attack Voice | OwnerDefault Attack Voice |  |  |
| volume | 1f | 1f |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Init | FINISHED | Tumble Out | 0 | 0 | 0 |
| Tumble Out | FINISHED | GG Tumble | 0 | 0 | 0 |
| In Air | WALL | Reflect | 0 | 0 | 0 |
| In Air | LAND | Trip? | 0 | 0 | 0 |
| Reflect | FINISHED | In Air | 0 | 0 | 0 |
| Fall Over | FINISHED | Get Up | 0 | 0 | 0 |
| Get Up | FINISHED | Roar? | 0 | 0 | 0 |
| Roar? | ROARED | Idle | 0 | 0 | 0 |
| Roar? | FINISHED | Roar Antic | 0 | 0 | 0 |
| Idle | FINISHED | Move Choice | 0 | 0 | 0 |
| Roar | FINISHED | Roar End | 0 | 0 | 0 |
| Roar Antic | FINISHED | Roar | 0 | 0 | 0 |
| Roar End | FINISHED | Roar Recover | 0 | 0 | 0 |
| Roar Recover | FINISHED | Idle | 0 | 0 | 0 |
| Move Choice | ATTACK | Attack Antic | 0 | 0 | 0 |
| Move Choice | JUMP | Jump Aim | 0 | 0 | 0 |
| Jump Aim | FINISHED | Jump Antic | 0 | 0 | 0 |
| Jump Antic | FINISHED | Jump Launch | 0 | 0 | 0 |
| Jump Launch | FINISHED | In Air | 0 | 0 | 0 |
| Trip? | TRIP | Fall Over | 0 | 0 | 0 |
| Trip? | LAND | Land | 0 | 0 | 0 |
| Land | FINISHED | Idle | 0 | 0 | 0 |
| Attack Antic | FINISHED | Attack Chase | 0 | 0 | 0 |
| Attack Chase | WALL | Hit Wall | 0 | 0 | 0 |
| Attack Chase | END | Fall Over | 0 | 0 | 0 |
| Hit Wall | FINISHED | In Air | 0 | 0 | 0 |
| Hit Up | FINISHED | In Air | 0 | 0 | 0 |
| Hit Left | FINISHED | In Air | 0 | 0 | 0 |
| Hit Right | FINISHED | In Air | 0 | 0 | 0 |
| Hit Down | FINISHED | In Air | 0 | 0 | 0 |
| GG Tumble | FINISHED | In Air | 0 | 0 | 0 |

## Global Transitions

| Event | To | ColorIndex | LinkStyle | LinkConstraint |
| --- | --- | --- | --- | --- |
| HIT DOWN | Hit Down | 0 | 0 | 0 |
| HIT RIGHT | Hit Right | 0 | 0 | 0 |
| HIT LEFT | Hit Left | 0 | 0 | 0 |
| HIT UP | Hit Up | 0 | 0 | 0 |
