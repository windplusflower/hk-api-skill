...
| intName | "environmentTypeDefault" | "environmentTypeDefault" |  |  |
| storeValue | int Enviro Default | int Enviro Default | Variable |  |
...
| value | int Enviro Type | int Enviro Type |  |  |
...
| functionCall | checkEnvironment(???) | checkEnvironment(???) |  |  |
...
| sendEvent | "ENVIRO UPDATE" | "ENVIRO UPDATE" |  |  |
| delay | 0f | 0f |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| eventName | "ENVIRO UPDATE" | "ENVIRO UPDATE" |  |  |
...
| --- | --- | --- | --- | --- |
| intName | "environmentType" | "environmentType" |  |  |
| value | int Enviro Default | int Enviro Default |  |  |
