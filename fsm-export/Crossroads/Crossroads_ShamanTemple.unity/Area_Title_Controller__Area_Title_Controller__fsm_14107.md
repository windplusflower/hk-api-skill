...
| Only On Revisit | true | Boolean: true |
| Sub Area | true | Boolean: true |
| Visited Area | true | Boolean: true |
| Wait for Trigger | true | Boolean: true |

### Strings

| Name | Value | Raw/Type |
| --- | --- | --- |
| Area Event | SHAMANTEMPLE | String: SHAMANTEMPLE |
| Door Trigger |   | String:  |
| Entry Door |   | String:  |
