...
| --- | --- |
| FSM Name | FSM |
| GameObject Name | Overhead Detect |
| GameObject Path | non_infected_event/Zombie Guard/ |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Enter Event | HERO ABOVE | String: HERO ABOVE |
| Exit Event |   | String:  |
| Stay Event | HERO ABOVE | String: HERO ABOVE |
