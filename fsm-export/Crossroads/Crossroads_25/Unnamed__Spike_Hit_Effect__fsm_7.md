...
| Field | Value |
| --- | --- |
| FSM Name | Spike Hit Effect |
| GameObject Name | Unnamed |
| GameObject Path |  |
| Source Asset | /home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets60.assets |
...
| sendEvent | "SPIKE RECOIL" | "SPIKE RECOIL" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| No Box Down | FINISHED | Broadcast | 0 | 0 | 0 |
| No Box Up | FINISHED | Broadcast | 0 | 0 | 0 |
| No Box Left | FINISHED | Broadcast | 0 | 0 | 0 |
| No Box Right | FINISHED | Broadcast | 0 | 0 | 0 |

## Global Transitions

| Event | To | ColorIndex | LinkStyle | LinkConstraint |
| --- | --- | --- | --- | --- |
| SPIKE RECOIL | Invincible Pause | 0 | 0 | 0 |
