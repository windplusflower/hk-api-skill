...
| Withdraw Txt | [null] | NamedAssetPPtr:  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| childName | "Txt Withdraw Amount" | "Txt Withdraw Amount" |  |  |
| storeResult | GameObject Withdraw Txt | GameObject Withdraw Txt | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| intVariable | int Withdraw Amount | int Withdraw Amount | Variable |  |
| intValue | 0 | 0 |  |  |
| everyFrame | false | false |  |  |
...
| --- | --- | --- | --- | --- |
| intVariable | int Withdraw Amount | int Withdraw Amount | Variable |  |
| stringVariable | string Withdraw String | string Withdraw String | Variable |  |
| format | "" | "" |  |  |
| everyFrame | false | false |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Withdraw Txt | OwnerDefault Withdraw Txt |  |  |
| textString | string Withdraw String | string Withdraw String |  |  |
...
| intValue | int Withdraw Amount | int Withdraw Amount |  |  |
| everyFrame | false | false |  |  |
...
| storeValue | int Balance Check | int Balance Check | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| integer1 | int Withdraw Amount | int Withdraw Amount |  |  |
| integer2 | int Balance Check | int Balance Check |  |  |
...
| storeResult | int Withdraw Amount | int Withdraw Amount | Variable |  |
| everyFrame | false | false |  |  |
...
| functionCall | AddGeo(Withdraw Amount=int Withdraw Amount) | AddGeo(Withdraw Amount=int Withdraw Amount) |  |  |
...
| integer2 | int Withdraw Amount | int Withdraw Amount |  |  |
| operation | HutongGames.PlayMaker.Actions.IntOperator/Operation::Subtract | 1 |  |  |
| storeResult | int Balance | int Balance | Variable |  |
| everyFrame | false | false |  |  |
...
| --- | --- | --- | --- | --- |
| integer1 | int Balance Display | int Balance Display |  |  |
| integer2 | int Roller Int | int Roller Int |  |  |
| operation | HutongGames.PlayMaker.Actions.IntOperator/Operation::Subtract | 1 |  |  |
| storeResult | int Balance Display | int Balance Display | Variable |  |
| everyFrame | false | false |  |  |
...
| Up Pressed | FINISHED | Refresh Amount | 0 | 0 | 0 |
...
| Up Pressed Rpt | FINISHED | Refresh Amount | 0 | 0 | 0 |
...
| Up Pressed Rpt 2 | FINISHED | Refresh Amount | 0 | 0 | 0 |
...
| Not Zero? | FINISHED | Add Geo | 0 | 0 | 0 |
| Menu Down | FINISHED | Menu 1 Up | 0 | 0 | 0 |
| Pause | FINISHED | Menu Up | 0 | 0 | 0 |
| Add Geo | FINISHED | Confirm Down | 0 | 0 | 0 |
| Confirm Down | FINISHED | Decrement Balance | 0 | 0 | 0 |
| Decrement Balance | FINISHED | Set Roller | 0 | 0 | 0 |
