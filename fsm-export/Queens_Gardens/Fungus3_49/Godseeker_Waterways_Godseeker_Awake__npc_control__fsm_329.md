...
| Hero Always Left | false | Boolean: false |
| Hero Always Right | false | Boolean: false |
...
| Talk Allowed | false | Boolean: false |
| Talking | false | Boolean: false |
| Turned | false | Boolean: false |
| Turns To Speak | false | Boolean: false |

### Strings

| Name | Value | Raw/Type |
| --- | --- | --- |
| Prompt Name | Listen | String: Listen |
...
| labelName | string Prompt Name = "Listen" | string Prompt Name = "Listen" |  |  |
...
| successEvent | Event(OUT OF RANGE) | Event(OUT OF RANGE) |  |  |
...
| storeResult | Var Talk Allowed = False | Var Talk Allowed = False | Variable | Store Result |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Talk Allowed | bool Talk Allowed | Variable |  |
| isTrue | Event() | Event() |  |  |
...
| sendEvent | Event(MOVE LEFT) | Event(MOVE LEFT) |  |  |
...
| --- | --- | --- | --- | --- |
| boolVariables | FSMViewAvalonia2.FsmArray2 | FSMViewAvalonia2.FsmArray2 | Variable |  |
| sendEvent | Event(MOVE RIGHT) | Event(MOVE RIGHT) |  |  |
| storeResult | false | false | Variable |  |
| everyFrame | false | false |  |  |
...
| sendEvent | "CONVO START" | "CONVO START" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| sendEvent | "NPC CONVO START" | "NPC CONVO START" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| gameObject | OwnerDefault Self | OwnerDefault Self |  |  |
| animLibName | "" | "" |  |  |
| clipName | string Turn Anim Name | string Turn Anim Name |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Turned | bool Turned | Variable |  |
| boolValue | true | true |  |  |
| everyFrame | false | false |  |  |
...
| trueEvent | Event(TURN RIGHT) | Event(TURN RIGHT) |  |  |
| falseEvent | Event() | Event() |  |  |
| storeResult | false | false | Variable |  |
| everyFrame | false | false |  |  |
...
| --- | --- | --- | --- | --- |
| boolVariable | bool Turned | bool Turned | Variable |  |
| isTrue | Event(TURN BACK) | Event(TURN BACK) |  |  |
| isFalse | Event() | Event() |  |  |
| everyFrame | false | false |  |  |
...
| gameObject | OwnerDefault Hero Obj | OwnerDefault Hero Obj |  |  |
| behaviour | "HeroController" | "HeroController" | Behaviour |  |
| methodName | "PreventCastByDialogueEnd" | "PreventCastByDialogueEnd" | Method |  |
| parameters | FSMViewAvalonia2.FsmArray2 | FSMViewAvalonia2.FsmArray2 |  |  |
...
| Take Control | FINISHED | Turn Self? | 0 | 0 | 0 |
| Turn Hero Left | FINISHED | Convo Start | 0 | 0 | 0 |
| Move Hero Left | FINISHED | Turn Hero Right | 0 | 0 | 0 |
| Turn Hero Right | FINISHED | Convo Start | 0 | 0 | 0 |
| Convo Start | CONVO END | Convo End | 0 | 0 | 0 |
| Convo Start | HERO DAMAGED | Reset Convo | 0 | 0 | 0 |
| Turn Self R | FINISHED | Check Proximity | 0 | 0 | 0 |
| Turn Self L | FINISHED | Check Proximity | 0 | 0 | 0 |
| Turn Back | FINISHED | Pause | 0 | 0 | 0 |
| Turn Self? | TURN RIGHT | Turn Self R | 0 | 0 | 0 |
| Turn Self? | FINISHED | Check Proximity | 0 | 0 | 0 |
| Turn Self? | TURN LEFT | Turn Self L | 0 | 0 | 0 |
| In Range Turns | OUT OF RANGE | Idle | 0 | 0 | 0 |
| In Range Turns | UP PRESSED | Can Talk? | 0 | 0 | 0 |
| In Range Turns | DREAM DIALOGUE START | Dream Dialogue | 0 | 0 | 0 |
| Turns? | TRUE | In Range Turns | 0 | 0 | 0 |
| Turns? | FALSE | In Range | 0 | 0 | 0 |
| Inert | BIG TITLE END | Idle | 0 | 0 | 0 |
| Can Talk Bool? | TRUE | Turns? | 0 | 0 | 0 |
| Can Talk Bool? | FALSE | Idle | 0 | 0 | 0 |
| Dream Dialogue | DREAM DIALOGUE END | Idle | 0 | 0 | 0 |
| Start Pause | FINISHED | Init | 0 | 0 | 0 |
| Cancel Pause | FINISHED | Idle | 0 | 0 | 0 |
| Reset Convo | FINISHED | Convo End | 0 | 0 | 0 |
| Regain Control | FINISHED | Pause | 0 | 0 | 0 |
| Regain Control | TURN BACK | Turn Back | 0 | 0 | 0 |

## Global Transitions

| Event | To | ColorIndex | LinkStyle | LinkConstraint |
| --- | --- | --- | --- | --- |
| BIG TITLE START | Inert | 0 | 0 | 0 |
| NPC CONTROL OFF | Off | 0 | 0 | 0 |
| CONVO CANCEL | Cancel Pause | 0 | 0 | 0 |
...
| CONVO CANCEL | false |
| CONVO END | false |
| DREAM DIALOGUE END | false |
| DREAM DIALOGUE START | false |
| FALSE | false |
| GET LEFT | false |
| GET RIGHT | false |
| GET UP | false |
...
| MOVE LEFT | false |
| MOVE RIGHT | false |
| NPC CONTROL OFF | false |
| OUT OF RANGE | false |
| REPEAT | false |
| RIGHT | false |
| TITLE DISPLAYED | false |
| TRUE | false |
| TURN BACK | false |
| TURN LEFT | false |
| TURN RIGHT | false |
