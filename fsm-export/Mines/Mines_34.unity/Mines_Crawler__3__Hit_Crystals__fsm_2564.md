...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Hit Crystals | Mines Crawler (3)/Hit Crystals Effect (Hollow Knight/hollow_knight_Data\level273) | NamedAssetPPtr: [Mines Crawler (3)/Hit Crystals Effect (Hollow Knight/hollow_knight_Data\level273)] |
