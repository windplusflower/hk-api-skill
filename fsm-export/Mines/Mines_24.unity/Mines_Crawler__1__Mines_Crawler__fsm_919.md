...
| Edge Range Obj | Mines Crawler (1)/Edge Range (Hollow Knight/hollow_knight_Data\level265) | NamedAssetPPtr: [Mines Crawler (1)/Edge Range (Hollow Knight/hollow_knight_Data\level265)] |
| Wake Range Obj | [null] | NamedAssetPPtr: [null] |
| Wall Range Obj | Mines Crawler (1)/Wall Range (Hollow Knight/hollow_knight_Data\level265) | NamedAssetPPtr: [Mines Crawler (1)/Wall Range (Hollow Knight/hollow_knight_Data\level265)] |
...
| storeResult |   | [Mines Crawler (1)/Wall Range (Hollow Knight/hollow_knight_Data\level265)] | Variable |   |
