...
| GameObject Path |   |
| Source Asset | D:/SteamLibrary/steamapps/common/Hollow Knight/hollow_knight_Data/level275 |
| Start State | Pause |
| FSM PathId | 453 |
| GameObject PathId | 130 |
...
| --- | --- | --- |
| Item Name |   | String:  |
| PD Bool Name | gotCharm_34 | String: gotCharm_34 |
...
| delivery | HutongGames.PlayMaker.Actions.SendMessage/MessageType::SendMessage | 0 |   |   |
| options | UnityEngine.SendMessageOptions::DontRequireReceiver | 1 |   |   |
| functionCall |   | StoryRecord_acquired(PD Bool Name=string PD Bool Name = "gotCharm_34") |   |   |
