...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Hit Crystals | Crystal Crawler (1)/Hit Crystals Effect (Hollow Knight/hollow_knight_Data\level250) | NamedAssetPPtr: [Crystal Crawler (1)/Hit Crystals Effect (Hollow Knight/hollow_knight_Data\level250)] |
