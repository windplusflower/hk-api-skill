...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Hit Crystals | Crystal Crawler (2)/Hit Crystals Effect (Hollow Knight/hollow_knight_Data\level272) | NamedAssetPPtr: [Crystal Crawler (2)/Hit Crystals Effect (Hollow Knight/hollow_knight_Data\level272)] |
