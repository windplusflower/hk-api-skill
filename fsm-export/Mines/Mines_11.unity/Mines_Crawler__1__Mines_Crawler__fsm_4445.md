...
| Edge Range Obj | Mines Crawler (1)/Edge Range (Hollow Knight/hollow_knight_Data\level256) | NamedAssetPPtr: [Mines Crawler (1)/Edge Range (Hollow Knight/hollow_knight_Data\level256)] |
| Wake Range Obj | [null] | NamedAssetPPtr: [null] |
| Wall Range Obj | Mines Crawler (1)/Wall Range (Hollow Knight/hollow_knight_Data\level256) | NamedAssetPPtr: [Mines Crawler (1)/Wall Range (Hollow Knight/hollow_knight_Data\level256)] |
...
| storeResult |   | [Mines Crawler (1)/Wall Range (Hollow Knight/hollow_knight_Data\level256)] | Variable |   |
