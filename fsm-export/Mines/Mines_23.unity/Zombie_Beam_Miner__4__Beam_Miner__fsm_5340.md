...
| --- | --- |
| FSM Name | Beam Miner |
| GameObject Name | Zombie Beam Miner (4) |
| GameObject Path |   |
...
| Laser Origin | Zombie Beam Miner (4)/Laser Origin (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level264) | NamedAssetPPtr: [Zombie Beam Miner (4)/Laser Origin (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level264)] |
