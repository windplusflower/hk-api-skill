...
| GameObject Path | _Props/RestBench/ |
...
| toValue |   | Color(1, 1, 1, 0.36862746) |   |   |
...
| material |   | [FsmMaterial not implemented] |   |   |
| namedColor |   | "_Color" | NamedColor |   |
| color |   | Color Bench Prev Colour | Variable |   |
| fail |   | Event() |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| fromValue |   | Color Bench Prev Colour |   |   |
| toValue |   | Color(1, 1, 1, 0) |   |   |
| colorVariable |   | Color Bench Colour | Variable |   |
| time |   | 0.5f |   |   |
| speed |   | 0f |   |   |
| delay |   | 0f |   |   |
| easeType |   | 21 |   |   |
