...
| --- | --- |
| FSM Name | Beam Miner |
| GameObject Name | Zombie Beam Miner (2) |
| GameObject Path |   |
...
| Laser Origin | Zombie Beam Miner (2)/Laser Origin (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level266) | NamedAssetPPtr: [Zombie Beam Miner (2)/Laser Origin (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level266)] |
