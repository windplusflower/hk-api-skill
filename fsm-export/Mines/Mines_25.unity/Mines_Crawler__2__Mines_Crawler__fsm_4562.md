...
| Edge Range Obj | Mines Crawler (2)/Edge Range (Hollow Knight/hollow_knight_Data\level266) | NamedAssetPPtr: [Mines Crawler (2)/Edge Range (Hollow Knight/hollow_knight_Data\level266)] |
| Wake Range Obj | [null] | NamedAssetPPtr: [null] |
| Wall Range Obj | Mines Crawler (2)/Wall Range (Hollow Knight/hollow_knight_Data\level266) | NamedAssetPPtr: [Mines Crawler (2)/Wall Range (Hollow Knight/hollow_knight_Data\level266)] |
...
| storeResult |   | [Mines Crawler (2)/Wall Range (Hollow Knight/hollow_knight_Data\level266)] | Variable |   |
