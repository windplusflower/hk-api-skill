...
| Edge Range Obj | Mines Crawler (1)/Edge Range (Hollow Knight/hollow_knight_Data\level276) | NamedAssetPPtr: [Mines Crawler (1)/Edge Range (Hollow Knight/hollow_knight_Data\level276)] |
| Wake Range Obj | [null] | NamedAssetPPtr: [null] |
| Wall Range Obj | Mines Crawler (1)/Wall Range (Hollow Knight/hollow_knight_Data\level276) | NamedAssetPPtr: [Mines Crawler (1)/Wall Range (Hollow Knight/hollow_knight_Data\level276)] |
...
| storeResult |   | [Mines Crawler (1)/Wall Range (Hollow Knight/hollow_knight_Data\level276)] | Variable |   |
