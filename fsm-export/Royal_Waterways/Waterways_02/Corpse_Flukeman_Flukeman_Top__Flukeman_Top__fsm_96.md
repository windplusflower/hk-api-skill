...
| Field | Value |
| --- | --- |
| FSM Name | Flukeman Top |
| GameObject Name | Flukeman Top |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Blood Point | [null] | NamedAssetPPtr:  |
...
| childName | "Blood Point" | "Blood Point" |  |  |
| storeResult | GameObject Blood Point | GameObject Blood Point | Variable |  |
...
| acceleration | 0.35f | 0.35f |  |  |
| targetSpread | 2f | 2f |  |  |
| spreadResetTimeMin | 0.5f | 0.5f |  |  |
| spreadResetTimeMax | 1f | 1f |  |  |
...
| Fall | FINISHED | Startle | 0 | 0 | 0 |
| Startle | FINISHED | Speed | 0 | 0 | 0 |
| Chase | FINISHED | Speed | 0 | 0 | 0 |
| Speed | FINISHED | Chase | 0 | 0 | 0 |
