...
| childName | "UI List Stag" | "UI List Stag" |  |  |
...
| id | "" | "" |  |  |
| transformScale |  |  |  |  |
| vectorScale | Vector3(1.264597, 1.264597, 1.264597) | Vector3(1.264597, 1.264597, 1.264597) |  |  |
| time | 0.5f | 0.5f |  |  |
| delay | 0f | 0f |  |  |
| speed | 0f | 0f |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| sendEvent | Event(CONT) | Event(CONT) |  |  |
...
| sendEvent | "STAG MENU DOWN" | "STAG MENU DOWN" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| storeValue | string Selection Result | string Selection Result | Variable |  |
| everyFrame | false | false |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Requester | OwnerDefault Requester |  |  |
| fsmName | "Stag Control" | "Stag Control" | FsmName |  |
| variableName | "Selection Result" | "Selection Result" | FsmString |  |
| setValue | string Selection Result | string Selection Result |  |  |
| everyFrame | false | false |  |  |
...
| Up | UI SELECTION MADE | Close | 0 | 0 | 0 |
| Pause | CONT | Init | 0 | 0 | 0 |
| Close | FINISHED | Send | 0 | 0 | 0 |
