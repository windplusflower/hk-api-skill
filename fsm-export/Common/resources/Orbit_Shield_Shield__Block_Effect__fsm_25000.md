...
| --- | --- | --- | --- | --- | --- |
| Idle | BLOCK EFFECT | Block | 0 | 0 | 0 |
| Block | FINISHED | Idle | 0 | 0 | 0 |

## Global Transitions

| Event | To | ColorIndex | LinkStyle | LinkConstraint |
| --- | --- | --- | --- | --- |
| ORBIT SHIELD DOWN | Idle | 0 | 0 | 0 |
