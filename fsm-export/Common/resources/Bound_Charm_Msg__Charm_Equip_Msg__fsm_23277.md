...
| Field | Value |
| --- | --- |
| FSM Name | Charm Equip Msg |
| GameObject Name | Bound Charm Msg |
| GameObject Path |  |
| Source Asset | /home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/resources.assets |
| Start State | Button Info? |
| FSM PathId | 23277 |
| GameObject PathId | 6421 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Button Info | [null] | NamedAssetPPtr:  |
...
| wasPressed | Event(FINISHED) | Event(FINISHED) |  |  |
...
| sendEvent | "CHARM MSG DOWN" | "CHARM MSG DOWN" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Bench Sit | bool Bench Sit | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Button Info | OwnerDefault Button Info |  |  |
...
| Init | INVENTORY CLOSED | Down | 0 | 0 | 0 |
| Init | INVENTORY OPENED | Down | 0 | 0 | 0 |
| Init | INV PANEL CHANGE | Down | 0 | 0 | 0 |
| Up | FINISHED | Down | 0 | 0 | 0 |
| Up | INVENTORY CLOSED | Down | 0 | 0 | 0 |
| Up | INVENTORY OPENED | Down | 0 | 0 | 0 |
| Up | INV PANEL CHANGE | Down | 0 | 0 | 0 |
| Down | FINISHED | Destroy | 0 | 0 | 0 |
| Bench Down | FINISHED | Down | 0 | 0 | 0 |
| Button Info? | FINISHED | Init | 0 | 0 | 0 |

## Global Transitions

| Event | To | ColorIndex | LinkStyle | LinkConstraint |
| --- | --- | --- | --- | --- |
| CHARM MSG | Destroy | 0 | 0 | 0 |
| CLOSE | Down | 0 | 0 | 0 |
| BENCH CLOSE | Bench Down | 0 | 0 | 0 |
