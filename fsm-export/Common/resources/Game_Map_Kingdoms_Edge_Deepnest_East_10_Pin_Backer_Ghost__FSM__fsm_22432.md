...
| GameObject Path | Game_Map/Kingdoms_Edge/Deepnest_East_10 |
| Source Asset | /home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/resources.assets |
| Start State | Check |
| FSM PathId | 22432 |
| GameObject PathId | 4456 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Completed Bool | killedGhostMarkoth | String: killedGhostMarkoth |
| Pin Type Bool | hasPinGhost | String: hasPinGhost |
| Specific Bool | markothPinned | String: markothPinned |
