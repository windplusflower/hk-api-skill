...
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| id | "" | "" |  |  |
| vector | Vector3(-0.5, 0, 0) | Vector3(-0.5, 0, 0) |  |  |
| time | 0.15f | 0.15f |  |  |
| delay | 0f | 0f |  |  |
| speed | 0f | 0f |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Init | ARROW L ANIM START | Anim Up | 0 | 0 | 0 |
| Anim Up | FINISHED | Anim Back | 0 | 0 | 0 |
| Anim Back | FINISHED | Init | 0 | 0 | 0 |
