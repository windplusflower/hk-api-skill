...
| Move Vector | Vector3(-3, 0, 0) | Vector3: Vector3(-3, 0, 0) |
...
| Hero Parent | [null] | NamedAssetPPtr:  |
...
| storeResult | GameObject Hero Parent | GameObject Hero Parent | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | GameObject Hero Parent | GameObject Hero Parent | Variable |  |
| isNull | Event() | Event() |  |  |
| isNotNull | Event(SUPERDASH CANCEL) | Event(SUPERDASH CANCEL) |  |  |
