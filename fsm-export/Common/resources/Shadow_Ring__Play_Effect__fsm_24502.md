...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| target | Vector3(1.4, 1.4, 1.4) | Vector3(1.4, 1.4, 1.4) |  |  |
| duration | 0.4f | 0.4f |  |  |
| delay | 0f | 0f |  |  |
| curve | HutongGames.PlayMaker.Actions.ScaleToCurves::QuadraticOut | 1 |  |  |
