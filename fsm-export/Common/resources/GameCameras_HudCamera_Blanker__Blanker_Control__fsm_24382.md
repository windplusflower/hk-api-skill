...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| variable | [Global] GameObject HUD Blanker | [Global] GameObject HUD Blanker | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| fromValue | Color(0, 0, 0, 0) | Color(0, 0, 0, 0) |  |  |
| toValue | Color(0, 0, 0, 1) | Color(0, 0, 0, 1) |  |  |
| colorVariable | Color Colour | Color Colour | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| fromValue | Color(0, 0, 0, 1) | Color(0, 0, 0, 1) |  |  |
| toValue | Color(0, 0, 0, 0) | Color(0, 0, 0, 0) |  |  |
| colorVariable | Color Colour | Color Colour | Variable |  |
| time | float Fade Time | float Fade Time |  |  |
| speed | 0f | 0f |  |  |
| delay | 0f | 0f |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Cancel Reset | bool Cancel Reset | Variable |  |
...
| Scene Reset | FINISHED | Idle | 0 | 0 | 0 |
| Scene Reset | CANCEL | Cancel | 0 | 0 | 0 |
| Idle | FADE IN | Fade In | 0 | 0 | 0 |
| Cancel | FADE OUT | Fade Out | 0 | 0 | 0 |
...
| --- | --- | --- | --- | --- |
| LEVEL LOADED | Scene Reset | 0 | 0 | 0 |
