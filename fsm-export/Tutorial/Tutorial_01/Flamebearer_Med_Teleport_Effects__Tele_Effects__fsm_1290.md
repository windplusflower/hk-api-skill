...
| Field | Value |
| --- | --- |
| FSM Name | Tele Effects |
| GameObject Name | Teleport Effects |
| GameObject Path | Flamebearer Med |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| childName | "Pt Tele" | "Pt Tele" |  |  |
| storeResult | GameObject Pt Tele | GameObject Pt Tele | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Pt Tele | OwnerDefault Pt Tele |  |  |
| emit | 0 | 0 |  |  |
...
| Idle | TELEPORT | Effects | 0 | 0 | 0 |
| Effects | FINISHED | Idle | 0 | 0 | 0 |
| Pillar | FINISHED | Idle | 0 | 0 | 0 |
