...
| --- | --- |
| FSM Name | FSM |
| GameObject Name | Lost hero Region |
| GameObject Path | Ruins Flying Sentry Javelin (1)/ |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Bool Name | Lost Region | String: Lost Region |
| FSM Name | Lost Hero Check | String: Lost Hero Check |
