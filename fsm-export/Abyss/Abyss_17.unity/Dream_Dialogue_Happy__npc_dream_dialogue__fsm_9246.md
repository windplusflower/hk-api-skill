...
| GameObject Name | Dream Dialogue Happy |
| GameObject Path | Cloth NPC Tramway/ |
| Source Asset | Hollow Knight/hollow_knight_Data/level341 |
| Start State | Init |
| FSM PathId | 9246 |
| GameObject PathId | 2624 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Convo Name | CLOTH_TRAMWAY_DREAM_HAPPY | String: CLOTH_TRAMWAY_DREAM_HAPPY |
