...
| GameObject Path |   |
| Source Asset | D:/SteamLibrary/steamapps/common/Hollow Knight/hollow_knight_Data/level381 |
| Start State | Init |
| FSM PathId | 5130 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Game Text Convo | PLAQUE_WARN | String: PLAQUE_WARN |
| Game Text Sheet | CP2 | String: CP2 |
