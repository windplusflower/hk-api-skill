...
| GameObject Path |   |
| Source Asset | Hollow Knight/hollow_knight_Data/level377 |
| Start State | Pause |
| FSM PathId | 7036 |
...
| Globe Dark | White Palace Orb Lever/Globe Dark (Hollow Knight/hollow_knight_Data\level377) | NamedAssetPPtr: [White Palace Orb Lever/Globe Dark (Hollow Knight/hollow_knight_Data\level377)] |
| Globe Lit | White Palace Orb Lever/Globe Lit (Hollow Knight/hollow_knight_Data\level377) | NamedAssetPPtr: [White Palace Orb Lever/Globe Lit (Hollow Knight/hollow_knight_Data\level377)] |
...
| --- | --- | --- | --- | --- |
| audioPlayer |   | [Global] [Audio Player Actor (Hollow Knight/hollow_knight_Data\resources.assets)] |   |   |
| spawnPoint |   | [White Palace Orb Lever/Globe Lit (Hollow Knight/hollow_knight_Data\level377)] |   |   |
