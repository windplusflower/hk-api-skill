...
| Royal Gaurd | [null] | NamedAssetPPtr: [null] |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Royal Gaurd |   |   |
| activate |   | false |   |   |
| recursive |   | false |   |   |
| resetOnExit |   | false |   |   |
| everyFrame |   | false |   |   |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| ROYAL GUARD KILLED | Check Pause | 0 | |
...
##### 1. GameObjectHasChildren

Full Name: HutongGames.PlayMaker.Actions.GameObjectHasChildren
Enabled: true
...
| audioPlayer |   | [Global] [Audio Player Actor 2D (Hollow Knight/hollow_knight_Data\resources.assets)] |   |   |
| spawnPoint |   | [Global] GameObject Hero |   |   |
| audioClip |   | [Final Boss transition and end sting (AudioClip) (Hollow Knight/hollow_knight_Data\sharedassets383.assets)] |   |   |
| pitchMin |   | 1f |   |   |
| pitchMax |   | 1f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
