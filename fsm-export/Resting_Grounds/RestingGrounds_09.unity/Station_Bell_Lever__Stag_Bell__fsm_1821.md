...
| --- | --- |
| FSM Name | Stag Bell |
| GameObject Name | Station Bell Lever |
| GameObject Path |   |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| PlayerData Bool | openedRestingGrounds | String: openedRestingGrounds |
...
| boolName |   | string PlayerData Bool = "openedRestingGrounds" |   |   |
| isTrue |   | Event(OPENED) |   |   |
| isFalse |   | Event() |   |   |
