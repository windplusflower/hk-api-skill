...
| GameObject Path |   |
| Source Asset | Hollow Knight/hollow_knight_Data/level157 |
| Start State | Init |
| FSM PathId | 5837 |
| GameObject PathId | 1645 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Game Text Convo | GREEN_TABLET_01 | String: GREEN_TABLET_01 |
| Game Text Sheet | Lore Tablets | String: Lore Tablets |
