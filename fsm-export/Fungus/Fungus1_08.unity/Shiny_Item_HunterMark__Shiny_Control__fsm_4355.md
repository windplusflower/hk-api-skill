...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable |   | bool Hunter | Variable |   |
| isTrue |   | Event(BIG) |   |   |
| isFalse |   | Event() |   |   |
| everyFrame |   | false |   |   |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| GET ITEM MSG END | Achievement | 0 | |
