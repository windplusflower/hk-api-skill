...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Parent Scale | 0 | Single: 0 |

### Vector3s

| Name | Value | Raw/Type |
| --- | --- | --- |
| Parent Pos | Vector2(0, 0) | Vector2: Vector2(0, 0) |
...
| vector |   | Vector3 Parent Pos | Variable |   |
| x |   | 0f | Variable |   |
| y |   | 0f | Variable |   |
| z |   | 0f | Variable |   |
...
| xScale |   | float Parent Scale | Variable |   |
| yScale |   | 0f | Variable |   |
| zScale |   | 0f | Variable |   |
| space | UnityEngine.Space::World | 0 |   |   |
| everyFrame |   | false |   |   |
