...
| Field | Value |
| --- | --- |
| FSM Name | Stag Control |
| GameObject Name | Stag |
| GameObject Path |   |
...
| Station Position Number | 3 | Int32: 3 |
| Stations Opened | 0 | Int32: 0 |
| To Position | 0 | Int32: 0 |
...
| Opened 3 | false | Boolean: false |
| Opened 6 | false | Boolean: false |
| Opened 9 | false | Boolean: false |
| Remember Convo 1 | false | Boolean: false |
| Remember Convo 2 | false | Boolean: false |
| Remember Convo 3 | false | Boolean: false |
| Station Opened | false | Boolean: false |
...
| --- | --- | --- |
| Item Name |   | String:  |
| Prompt Name | openedFungalWastes | String: openedFungalWastes |
| Selection Result | openedFungalWastes | String: openedFungalWastes |
| Station Opened Bool | openedFungalWastes | String: openedFungalWastes |
...
| Arrival Anim | [null] | NamedAssetPPtr: [null] |
| Arrival Dust | [null] | NamedAssetPPtr: [null] |
...
| Travel Range | [null] | NamedAssetPPtr: [null] |
...
| --- | --- | --- | --- | --- |
| objectName |   | "" |   |   |
| withTag |   | "Stag Grate" | Tag |   |
| store |   | GameObject Grate | Variable |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Travel Range" |   |   |
| storeResult |   | GameObject Travel Range | Variable |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Arrival Dust" |   |   |
| storeResult |   | GameObject Arrival Dust | Variable |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Arrival Anim" |   |   |
| storeResult |   | GameObject Arrival Anim | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| stringVariable |   | string Prompt Name = "Travel" | Variable |   |
| stringValue |   | "Travel" | TextArea |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- |
| FINISHED | Reset HUD and Flower Check | 0 | |

### Check if Station Opened
...
| boolName |   | string Station Opened Bool = "openedTown" |   |   |
| isTrue |   | Event(OPENED) |   |   |
| isFalse |   | Event(CLOSED) |   |   |

#### Transitions

| Event | To State | Color Index | |
| --- | --- | --- | --- |
| OPENED | Station Opened | 0 | |
| CLOSED | Station Closed | 0 | |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable |   | bool Station Opened | Variable |   |
| boolValue |   | false |   |   |
| everyFrame |   | false |   |   |
...
| integer2 |   | int Station Position Number |   |   |
| equal |   | Event(PRESENT) |   |   |
| lessThan |   | Event(AWAY) |   |   |
| greaterThan |   | Event(AWAY) |   |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| intName |   | "stagPosition" |   |   |
| value |   | int Station Position Number |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Grate |   |   |
| clipName |   | "Grate_disappear" |   |   |
...
| audioClip |   | [stag_arrive (AudioClip) (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\sharedassets9.assets)] |   |   |
| pitchMin |   | 1f |   |   |
| pitchMax |   | 1f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
...
| intValue |   | int Station Position Number |   |   |
| everyFrame |   | false |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Arrival Anim |   |   |
| active |   | true |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Arrival Dust |   |   |
| active |   | true |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Travel Range |   |   |
| activate |   | true |   |   |
| recursive |   | true |   |   |
| resetOnExit |   | false |   |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Self |   |   |
| fsmName |   | "advance_conversation" | FsmName |   |
| variableName |   | "Conversing" | FsmBool |   |
| setValue |   | true |   |   |
| everyFrame |   | false |   |   |
...
| functionCall |   | StoryRecord_rodeStag(To Scene=string To Scene = "Room_Town_Stag_Station") |   |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault GameManager |   |   |
| stringName |   | "nextScene" |   |   |
| value |   | string To Scene = "Room_Town_Stag_Station" |   |   |
...
| gameObject |   | OwnerDefault GameManager |   |   |
| behaviour |   | "GameManager" | Behaviour |   |
| methodName |   | "SaveLevelState" | Method |   |
| parameters |   | FSMViewAvalonia2.FsmArray2 |   |   |
| storeResult |   | Var unnamed = 0 | Variable | Store Result |
...
Full Name: HutongGames.PlayMaker.Actions.LoadLevel
Enabled: true

| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| levelName |   | "Cinematic_Stag_travel" |   |   |
| additive |   | false |   |   |
| async |   | false |   |   |
| loadedEvent |   | Event() |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault MenuHolder |   |   |
| fsmName |   | "Open Stag" | FsmName |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| eventTarget |   | EventTarget(GameObject):MenuHolder |   |   |
| sendEvent |   | "OPEN STAG MENU" |   |   |
| delay |   | 0f |   |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| eventTarget |   | EventTarget(Self):FSM Owner |   |   |
| sendEvent |   | string Selection Result |   |   |
| delay |   | 0f |   |   |
| everyFrame |   | false |   |   |
...
| Dirtmouth | Dirtmouth | 0 | |
| Forest Of Bones |   | 0 | |
| Fungal Wastes | Fungal Wastes | 0 | |
| Greenpath | Greenpath | 0 | |
| Palace Grounds |   | 0 | |
| Resting Grounds | Resting Grounds | 0 | |
| Royal Gardens | Royal Gardens | 0 | |
| City Storerooms | City Storerooms | 0 | |
| Kings Station | Kings Station | 0 | |
| Deepnest | Deepnest | 0 | |
| Stag Nest | Stag Nest | 0 | |
| Hidden Station | Hidden Station | 0 | |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| intVariable |   | int To Position | Variable |   |
| intValue |   | 1 |   |   |
| everyFrame |   | false |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "Crossroads_47" | TextArea |   |
| everyFrame |   | false |   |   |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| FINISHED | Current Location Check | 0 | |
...
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "Room_Town_Stag_Station" | TextArea |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "Fungus1_16_alt" | TextArea |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "Fungus2_02" | TextArea |   |
| everyFrame |   | false |   |   |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| FINISHED | Go To Stag Cutscene | 0 | |
...
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "Ruins1_29" | TextArea |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "RestingGrounds_09" | TextArea |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "Ruins2_08" | TextArea |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "Deepnest_09" | TextArea |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault GameManager |   |   |
| trueBool |   | "stagEggInspected" |   |   |
| falseBool |   | "stagHopeConvo" |   |   |
| isTrue |   | Event(HOPE) |   |   |
| isFalse |   | Event() |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolName |   | "stagRemember1" |   |   |
| storeValue |   | bool Remember Convo 1 | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolName |   | "stagRemember2" |   |   |
| storeValue |   | bool Remember Convo 2 | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolName |   | "stagRemember3" |   |   |
| storeValue |   | bool Remember Convo 3 | Variable |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault GameManager |   |   |
| intName |   | "stationsOpened" |   |   |
| storeValue |   | int Stations Opened | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| int1 |   | int Stations Opened |   |   |
| int2 |   | 2 |   |   |
| equalBool |   | false | Variable |   |
| lessThanBool |   | false | Variable |   |
| greaterThanBool |   | bool Opened 3 | Variable |   |
| everyFrame |   | false |   |   |
...
| equalBool |   | false | Variable |   |
| lessThanBool |   | false | Variable |   |
| greaterThanBool |   | bool Opened 6 | Variable |   |
| everyFrame |   | false |   |   |
...
| equalBool |   | false | Variable |   |
| lessThanBool |   | false | Variable |   |
| greaterThanBool |   | bool Opened 9 | Variable |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- |
| FINISHED | Open map | 0 | |
| REMEMBER 1 | Title Check | 0 | |
| REMEMBER 2 | Title Check | 0 | |
| REMEMBER 3 | Title Check | 0 | |
| MEET | Title Check | 0 | |
| HOPE | Title Check | 0 | |
| FLOWER | Title Check | 0 | |
...
| --- | --- | --- | --- |
| FINISHED |   | 0 | |
| REMEMBER 1 | Remember 1 | 0 | |
| REMEMBER 2 | Remember 2 | 0 | |
| REMEMBER 3 | Remember 3 | 0 | |
| MEET | Meeting | 0 | |
| HOPE | Hope 1 | 0 | |
| FLOWER | Flower | 0 | |
...
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "Fungus3_40" | TextArea |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| stringVariable |   | string To Scene = "Room_Town_Stag_Station" | Variable |   |
| stringValue |   | "Cliffs_03" | TextArea |   |
| everyFrame |   | false |   |   |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| FINISHED | Meeting End | 0 | |

### Reset HUD and Flower Check
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| FINISHED | Check if Station Opened | 0 | |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | [Global] [Area Title Extra (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\sharedassets9.assets)] |   |   |
| spawnPoint |   |   |   |   |
| position |   | Vector3(0, 0, 0) |   |   |
| rotation |   | Vector3(0, 0, 0) |   |   |
| storeObject |   | GameObject Area Title | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| integer1 |   | int Station Position Number |   |   |
| integer2 |   | 10 |   |   |
| equal |   | Event() |   |   |
...
| labelName |   | string Prompt Name = "Travel" |   |   |
...
| FINISHED | false |
| FLOWER | false |
| Forest Of Bones | false |
| Fungal Wastes | false |
| Greenpath | false |
| HOPE | false |
| Hidden Station | false |
| IN RANGE | false |
| Kings Station | false |
| L | false |
| LAST | false |
