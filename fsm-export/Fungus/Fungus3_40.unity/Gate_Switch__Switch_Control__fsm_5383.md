...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Player Data | openedGardensStagStation | String: openedGardensStagStation |
...
| Target | royal_garden_slide_door (1) (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level220) | NamedAssetPPtr: [royal_garden_slide_door (1) (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level220)] |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| eventTarget |   | EventTarget(GameObject):Target |   |   |
| sendEvent |   | "ACTIVATE" |   |   |
| delay |   | 0f |   |   |
| everyFrame |   | false |   |   |
