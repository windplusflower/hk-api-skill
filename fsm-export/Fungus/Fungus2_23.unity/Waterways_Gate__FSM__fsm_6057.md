...
| --- | --- |
| FSM Name | FSM |
| GameObject Name | Waterways Gate |
| GameObject Path |   |
| Source Asset | Hollow Knight/hollow_knight_Data/level187 |
| Start State | Init Pause |
| FSM PathId | 6057 |
| GameObject PathId | 1652 |
...
| Corpse Spawn Point | Vector2(0, 0) | Vector2: Vector2(0, 0) |
