...
| Dust Break Floor | [null] | NamedAssetPPtr: [null] |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Dust Break Floor" |   |   |
| storeResult |   | GameObject Dust Break Floor | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Dust Break Floor |   |   |
| parent |   |   |   |   |
