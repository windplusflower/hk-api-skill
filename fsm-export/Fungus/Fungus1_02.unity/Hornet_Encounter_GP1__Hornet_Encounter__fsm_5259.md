...
| Turn Range | false | Boolean: false |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable |   | bool Turn Range | Variable |   |
| isTrue |   | Event(TURN) |   |   |
| isFalse |   | Event() |   |   |
| everyFrame |   | true |   |   |
