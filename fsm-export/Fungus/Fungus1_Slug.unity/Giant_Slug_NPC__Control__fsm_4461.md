...
| --- | --- |
| FSM Name | Control |
| GameObject Name | Giant Slug NPC |
| GameObject Path |   |
...
| Pt Spore In | [null] | NamedAssetPPtr: [null] |
| Pt Steam | [null] | NamedAssetPPtr: [null] |
| Pt Steam In | [null] | NamedAssetPPtr: [null] |
| Shiny Item | [null] | NamedAssetPPtr: [null] |
| Spatter Point | [null] | NamedAssetPPtr: [null] |
...
| boolName |   | "slugEncounterComplete" |   |   |
| isTrue |   | Event(SEEN) |   |   |
| isFalse |   | Event() |   |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Spatter Point" |   |   |
| storeResult |   | GameObject Spatter Point | Variable |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Pt Steam In" |   |   |
| storeResult |   | GameObject Pt Steam In | Variable |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Pt Spore In" |   |   |
| storeResult |   | GameObject Pt Spore In | Variable |   |
...
| spawnPoint |   | GameObject Spatter Point |   |   |
| audioClip |   | [uumuu_appear (AudioClip) (Hollow Knight/hollow_knight_Data\sharedassets164.assets)] |   |   |
| pitchMin |   | 1f |   |   |
| pitchMax |   | 1f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
...
| variableName |   | "Slug Fling" | FsmBool |   |
| setValue |   | true |   |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | [Global] [Spatter White R (Hollow Knight/hollow_knight_Data\resources.assets)] |   |   |
| spawnPoint |   | GameObject Shiny Item |   |   |
| position |   | Vector3(0, 0, 0) |   |   |
| spawnMin |   | 10 |   |   |
| spawnMax |   | 10 |   |   |
| speedMin |   | 10f |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Pt Spore In |   |   |
| emit |   | 0 |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Pt Steam In |   |   |
| emit |   | 0 |   |   |
...
| audioPlayer |   | [Global] [Audio Player Actor (Hollow Knight/hollow_knight_Data\resources.assets)] |   |   |
| spawnPoint |   | GameObject Spatter Point |   |   |
| audioClip |   | [acid_splash (AudioClip) (Hollow Knight/hollow_knight_Data\resources.assets)] |   |   |
| pitchMin |   | 0.75f |   |   |
| pitchMax |   | 0.75f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
