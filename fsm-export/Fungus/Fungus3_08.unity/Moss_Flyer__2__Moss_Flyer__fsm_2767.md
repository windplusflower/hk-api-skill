...
| GameObject Path |   |
| Source Asset | Hollow Knight/hollow_knight_Data/level202 |
| Start State | Init |
| FSM PathId | 2767 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Hide Grass | Moss Flyer (2)/Hide Grass (Hollow Knight/hollow_knight_Data\level202) | NamedAssetPPtr: [Moss Flyer (2)/Hide Grass (Hollow Knight/hollow_knight_Data\level202)] |
| Shake Grass | Moss Flyer (2)/Shake Grass (Hollow Knight/hollow_knight_Data\level202) | NamedAssetPPtr: [Moss Flyer (2)/Shake Grass (Hollow Knight/hollow_knight_Data\level202)] |
...
| spawnPoint |   | [Moss Flyer (2)/Hide Grass (Hollow Knight/hollow_knight_Data\level202)] |   |   |
