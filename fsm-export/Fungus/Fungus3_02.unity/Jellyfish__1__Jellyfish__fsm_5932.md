...
| GameObject Path |   |
| Source Asset | Hollow Knight/hollow_knight_Data/level198 |
| Start State | Init |
| FSM PathId | 5932 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Ring B | Jellyfish (1)/Ring B (Hollow Knight/hollow_knight_Data\level198) | NamedAssetPPtr: [Jellyfish (1)/Ring B (Hollow Knight/hollow_knight_Data\level198)] |
| Ring F | Jellyfish (1)/Ring F (Hollow Knight/hollow_knight_Data\level198) | NamedAssetPPtr: [Jellyfish (1)/Ring F (Hollow Knight/hollow_knight_Data\level198)] |
| Tent Box | Jellyfish (1)/Tentacle Box (Hollow Knight/hollow_knight_Data\level198) | NamedAssetPPtr: [Jellyfish (1)/Tentacle Box (Hollow Knight/hollow_knight_Data\level198)] |
| Trail | Jellyfish (1)/Trail (Hollow Knight/hollow_knight_Data\level198) | NamedAssetPPtr: [Jellyfish (1)/Trail (Hollow Knight/hollow_knight_Data\level198)] |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | [Jellyfish (1)/Tentacle Box (Hollow Knight/hollow_knight_Data\level198)] |   |   |
| delay |   | 0f |   |   |
