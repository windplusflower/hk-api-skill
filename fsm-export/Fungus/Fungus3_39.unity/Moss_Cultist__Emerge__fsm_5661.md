...
| audioClip |   | [Moss_Cultist_Hide (AudioClip) (Hollow Knight/hollow_knight_Data\sharedassets219.assets)] |   |   |
| pitchMin |   | 1f |   |   |
| pitchMax |   | 1f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
...
| --- | --- | --- | --- | --- |
| tag |   | "Boss" | Tag |   |
| storeResult |   | int Acolytes | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| integer1 |   | int Acolytes |   |   |
| integer2 |   | 0 |   |   |
| equal |   | Event(EMERGE) |   |   |
| lessThan |   | Event(EMERGE) |   |   |
| greaterThan |   | Event() |   |   |
| everyFrame |   | false |   |   |
