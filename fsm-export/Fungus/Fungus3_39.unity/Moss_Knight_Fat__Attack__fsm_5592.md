...
| --- | --- | --- |
| Bounces | 0 | Int32: 0 |
| Max Bounces | 0 | Int32: 0 |
| Max Start Bounces | 3 | Int32: 3 |
| Start Bounces | 0 | Int32: 0 |
...
| Bounce Range | false | Boolean: false |
| HERO IN RANGE | false | Boolean: false |
| Praying | true | Boolean: true |
...
| childName |   | "Particle" |   |   |
| storeResult |   | GameObject Particle | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable |   | bool Praying | Variable |   |
| isTrue |   | Event(LOOK AT) |   |   |
...
| min |   | 3 |   |   |
| max |   | 4 |   |   |
| storeResult |   | int Max Bounces | Variable |   |
| inclusiveMax |   | true |   |   |
...
| audioClip |   | [moss_knight_fat_land (AudioClip) (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\sharedassets219.assets)] |   |   |
| pitchMin |   | 0.85f |   |   |
| pitchMax |   | 1.1f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
...
| topHitEvent |   | Event() |   |   |
| rightHitEvent |   | Event(SIDE BOUNCE) |   |   |
| bottomHitEvent |   | Event(BOUNCE) |   |   |
| leftHitEvent |   | Event(SIDE BOUNCE) |   |   |
| otherLayer |   | false |   |   |
| otherLayerNumber |   | 0 |   |   |
...
| integer2 |   | int Max Bounces |   |   |
| equal |   | Event(LAND) |   |   |
| lessThan |   | Event(BOUNCE) |   |   |
...
| gameObject |   | OwnerDefault FSM Owner |   |   |
| animationTriggerEvent |   | Event() |   |   |
| animationCompleteEvent |   | Event(LAND) |   |   |
...
| --- | --- | --- | --- |
| LOOK AT | Look At | 0 | |
| TOOK DAMAGE | Look At | 0 | |
| MOSS FAT WAKE | Look At | 0 | |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable |   | bool Bounce Range | Variable |   |
| isTrue |   | Event(BOUNCE) |   |   |
| isFalse |   | Event() |   |   |
| everyFrame |   | true |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| intVariable |   | int Start Bounces | Variable |   |
| add |   | 1 |   |   |
| everyFrame |   | false |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| integer1 |   | int Start Bounces |   |   |
| integer2 |   | int Max Start Bounces |   |   |
| equal |   | Event(ATTACK) |   |   |
| lessThan |   | Event() |   |   |
| greaterThan |   | Event(ATTACK) |   |   |
| everyFrame |   | false |   |   |
...
| audioPlayer |   | [Global] [Audio Player Actor (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\resources.assets)] |   |   |
| spawnPoint |   | GameObject Self |   |   |
| audioClip |   | [moss_knight_fat_jump (AudioClip) (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\sharedassets219.assets)] |   |   |
| pitchMin |   | 0.85f |   |   |
| pitchMax |   | 1.1f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
