...
| storeValue |   | int Hornet Encounter | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| eventTarget |   | EventTarget(GameObject):Boss |   |   |
| sendEvent |   | "WAKE" |   |   |
| delay |   | 0f |   |   |
| everyFrame |   | false |   |   |
