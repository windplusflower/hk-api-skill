...
| Hero X | 0 | Single: 0 |
| Hero Y | 0 | Single: 0 |
| Hide Distance | 4 | Single: 4 |
| Raycast X | 0 | Single: 0 |
| Raycast Y | 0 | Single: 0 |
| Rotation Angle | 0 | Single: 0 |
| Rotation Speed | 360 | Single: 360 |
...
| offsetX |   | 0f |   |   |
| offsetY |   | 0f |   |   |
| storeAngle |   | float Rotation Angle |   |   |
| everyFrame |   | true |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| floatVariable |   | float Rotation Angle | Variable |   |
| add |   | -90f |   |   |
| everyFrame |   | true |   |   |
| perSecond |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| targetAngle |   | float Rotation Angle |   |   |
