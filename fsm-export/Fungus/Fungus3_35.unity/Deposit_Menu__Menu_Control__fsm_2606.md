...
| Deposit Txt | [null] | NamedAssetPPtr: [null] |
...
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Txt Deposit Amount" |   |   |
| storeResult |   | GameObject Deposit Txt | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| intVariable |   | int Deposit Amount | Variable |   |
| intValue |   | 0 |   |   |
| everyFrame |   | false |   |   |
...
| --- | --- | --- | --- | --- |
| intVariable |   | int Deposit Amount | Variable |   |
| stringVariable |   | string Deposit String | Variable |   |
| format |   | "" |   |   |
| everyFrame |   | false |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Deposit Txt |   |   |
| textString |   | string Deposit String |   |   |
...
| sheetName |   | "Prices" |   |   |
| convName |   | "BANK_LIMIT" |   |   |
| storeValue |   | string Balance Limit String | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| stringVariable |   | string Balance Limit String | Variable |   |
| intVariable |   | int Balance Limit | Variable |   |
| everyFrame |   | false |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| integer1 |   | int Deposit Amount |   |   |
| integer2 |   | int Player Geo |   |   |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| FINISHED | Check Balance Limit | 0 | |
...
| storeResult |   | int Deposit Amount | Variable |   |
| everyFrame |   | false |   |   |
...
| functionCall |   | TakeGeo(Deposit Amount=int Deposit Amount) |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| intVariable |   | int New Balance | Variable |   |
| intValue |   | int Balance |   |   |
| everyFrame |   | false |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| integer1 |   | int New Balance |   |   |
| integer2 |   | int Balance Limit |   |   |
| equal |   | Event(FINISHED) |   |   |
| lessThan |   | Event(FINISHED) |   |   |
| greaterThan |   | Event() |   |   |
| everyFrame |   | false |   |   |
...
| integer2 |   | int Balance Limit |   |   |
| operation | HutongGames.PlayMaker.Actions.IntOperator/Operation::Subtract | 1 |   |   |
| storeResult |   | int Balance Over | Variable |   |
| everyFrame |   | false |   |   |
