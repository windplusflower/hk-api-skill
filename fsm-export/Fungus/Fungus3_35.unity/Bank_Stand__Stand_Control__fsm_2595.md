...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| intVariable |   | int Theft State | Variable |   |
...
| storeValue |   | int damageDealt | Variable |   |
| everyFrame |   | false |   |   |
...
| integer1 |   | int Hits |   |   |
| integer2 |   | 3 |   |   |
| equal |   | Event(KNOCK OVER) |   |   |
| lessThan |   | Event(FINISHED) |   |   |
| greaterThan |   | Event(KNOCK OVER) |   |   |
| everyFrame |   | false |   |   |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| KNOCK OVER | Knock Over | 0 | |
| FINISHED | Banker Gone | 0 | |
