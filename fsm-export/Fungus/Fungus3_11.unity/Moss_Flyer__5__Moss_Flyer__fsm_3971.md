...
| GameObject Path |   |
| Source Asset | Hollow Knight/hollow_knight_Data/level204 |
| Start State | Init |
| FSM PathId | 3971 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Hide Grass | Moss Flyer (5)/Hide Grass (Hollow Knight/hollow_knight_Data\level204) | NamedAssetPPtr: [Moss Flyer (5)/Hide Grass (Hollow Knight/hollow_knight_Data\level204)] |
| Shake Grass | Moss Flyer (5)/Shake Grass (Hollow Knight/hollow_knight_Data\level204) | NamedAssetPPtr: [Moss Flyer (5)/Shake Grass (Hollow Knight/hollow_knight_Data\level204)] |
...
| spawnPoint |   | [Moss Flyer (5)/Hide Grass (Hollow Knight/hollow_knight_Data\level204)] |   |   |
