...
| GameObject Path |   |
| Source Asset | D:/SteamLibrary/steamapps/common/Hollow Knight/hollow_knight_Data/level281 |
| Start State | Pause |
| FSM PathId | 1121 |
...
| Station Position Number | 8 | Int32: 8 |
...
| --- | --- | --- |
| Item Name |   | String:  |
| Prompt Name | openedDeepnest | String: openedDeepnest |
| Selection Result | openedDeepnest | String: openedDeepnest |
| Station Opened Bool | openedDeepnest | String: openedDeepnest |
