...
| --- | --- |
| FSM Name | Control |
| GameObject Name | Hornet Blizzard Return Scene |
| GameObject Path |   |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Exit Puff | [null] | NamedAssetPPtr: [null] |
| Land Puff | [null] | NamedAssetPPtr: [null] |
...
| childName |   | "Exit Puff" |   |   |
| storeResult |   | GameObject Exit Puff | Variable |   |
...
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Land Puff" |   |   |
| storeResult |   | GameObject Land Puff | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Exit Puff |   |   |
| emit |   | 0 |   |   |
...
| audioClip |   | [jump_out_of_snow (AudioClip) (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\sharedassets316.assets)] |   |   |
| pitchMin |   | 1f |   |   |
| pitchMax |   | 1f |   |   |
| volume |   | 1f |   |   |
| delay |   | 0f |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Land Puff |   |   |
| emit |   | 0 |   |   |
