...
| --- | --- |
| FSM Name | Control |
| GameObject Name | Spider Flyer (1) |
| GameObject Path |   |
...
| Spawn Range Obj | Spider Flyer (1)/Spawn Range (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level300) | NamedAssetPPtr: [Spider Flyer (1)/Spawn Range (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level300)] |
