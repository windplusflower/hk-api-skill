...
| GameObject Path |   |
| Source Asset | D:/SteamLibrary/steamapps/common/Hollow Knight/hollow_knight_Data/level282 |
| Start State | Pause |
| FSM PathId | 2426 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Hero Offset | 1.52999997 | Single: 1.52999997 |
...
| Event | To State | Color Index | |
| --- | --- | --- | --- |
| HERO EXIT | Splash Out effects | 0 | |
...
| gameObject |   | [Global] GameObject HUD Camera |   |   |
| everyFrame |   | false |   |   |
