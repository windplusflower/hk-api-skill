...
| --- | --- |
| FSM Name | Control |
| GameObject Name | Spider Flyer (9) |
| GameObject Path |   |
...
| Spawn Range Obj | Spider Flyer (9)/Spawn Range (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level297) | NamedAssetPPtr: [Spider Flyer (9)/Spawn Range (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level297)] |
