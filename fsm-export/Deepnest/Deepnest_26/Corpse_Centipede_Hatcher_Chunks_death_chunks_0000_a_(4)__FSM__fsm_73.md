...
| --- | --- |
| FSM Name | FSM |
| GameObject Name | death_chunks_0000_a (4) |
| GameObject Path | Corpse Centipede Hatcher/Chunks |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Random Start Rotation | true | Boolean: true |
...
| multiplyBy | float Spin Factor | float Spin Factor |  |  |
| everyFrame | false | false |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| boolVariable | bool Random Start Rotation | bool Random Start Rotation | Variable |  |
| isTrue | Event() | Event() |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| min | -0.000999f | -0.000999f |  |  |
| max | 0.000999f | 0.000999f |  |  |
| storeResult | float z Translate | float z Translate | Variable |  |
...
| x | 0f | 0f |  |  |
| y | 0f | 0f |  |  |
| z | float z Translate | float z Translate |  |  |
| space | UnityEngine.Space::World | 0 |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Wait | FINISHED | Randomise z | 0 | 0 | 0 |
| Spin | RESPIN | Wait | 0 | 0 | 0 |
| Spin At Start? | FINISHED | Wait | 0 | 0 | 0 |
| Randomise z | FINISHED | Spin | 0 | 0 | 0 |
