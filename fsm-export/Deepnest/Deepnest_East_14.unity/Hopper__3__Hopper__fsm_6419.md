...
| --- | --- |
| FSM Name | Hopper |
| GameObject Name | Hopper (3) |
| GameObject Path | Hopper Spawn (2)/ |
| Source Asset | Hollow Knight/hollow_knight_Data/level318 |
| Start State | Init |
| FSM PathId | 6419 |
| GameObject PathId | 294 |
...
| Range Max | 999 | Single: 999 |
| Range Min | 129.289993 | Single: 129.289993 |
| Self X | 0 | Single: 0 |
...
| Roams Within Range | true | Boolean: true |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Hopper Spawn (2)/Hopper (3)/Wall Check |   |   |
| activate |   | false |   |   |
| recursive |   | false |   |   |
| resetOnExit |   | false |   |   |
| everyFrame |   | false |   |   |
