...
| --- | --- |
| FSM Name | BG Control |
| GameObject Name | Battle Gate Outskirts (1) |
| GameObject Path |   |
...
| Raise Dust | Battle Gate Outskirts (1)/Raise Dust (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level324) | NamedAssetPPtr: [Battle Gate Outskirts (1)/Raise Dust (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level324)] |
