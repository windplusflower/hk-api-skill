...
| --- | --- |
| FSM Name | BG Control |
| GameObject Name | Battle Gate Deepnest (5) |
| GameObject Path |   |
...
| Sprite | Battle Gate Deepnest (5)/Sprite (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level290) | NamedAssetPPtr: [Battle Gate Deepnest (5)/Sprite (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level290)] |
