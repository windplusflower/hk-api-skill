...
| Grub | [null] | NamedAssetPPtr: [null] |
| Other Grub | [null] | NamedAssetPPtr: [null] |
| Phys Box | [null] | NamedAssetPPtr: [null] |
| Pool | [null] | NamedAssetPPtr: [null] |
| Pt Glass L | Grub Bottle/Pt Glass L (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level289) | NamedAssetPPtr: [Grub Bottle/Pt Glass L (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level289)] |
| Pt Glass M | Grub Bottle/Pt Glass S (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level289) | NamedAssetPPtr: [Grub Bottle/Pt Glass S (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level289)] |
...
| functionCall |   | CheckGrubAchievements(???) |   |   |
...
Full Name: HutongGames.PlayMaker.Actions.SetName
Enabled: true
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | OwnerDefault Pt Glass M |   |   |
| emit |   | 0 |   |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| objectName |   | "Grub Bottle" |   |   |
| withTag |   | "Grub Bottle" | Tag |   |
| store |   | GameObject Other Grub | Variable |   |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | GameObject Other Grub | Variable |   |
| isNull |   | Event(SET) |   |   |
| isNotNull |   | Event() |   |   |
...
| gameObject |   | OwnerDefault FSM Owner |   |   |
| childName |   | "Grub" |   |   |
| storeResult |   | GameObject Grub | Variable |   |
...
| storeResult |   | GameObject Phys Box | Variable |   |
