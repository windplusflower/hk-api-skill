...
| --- | --- |
| FSM Name | Hopper |
| GameObject Name | Giant Hopper (2) |
| GameObject Path |   |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Dust | Giant Hopper (2)/Dust Land Small (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level310) | NamedAssetPPtr: [Giant Hopper (2)/Dust Land Small (D:\SteamLibrary\steamapps\common\Hollow Knight\hollow_knight_Data\level310)] |
