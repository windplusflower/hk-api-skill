...
| --- | --- |
| FSM Name | Get Quake |
| GameObject Name | Corpse Dream Mage Lord 1 |
| GameObject Path |  |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Arrive Particles | Corpse Dream Mage Lord 1/Arrive Particles (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets102.assets) | NamedAssetPPtr: Corpse Dream Mage Lord 1/Arrive Particles (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets102.assets) |
| CamLock | [null] | NamedAssetPPtr:  |
| GG Death | [null] | NamedAssetPPtr:  |
| Light 2 | Corpse Dream Mage Lord 1/Mage Lord (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets102.assets) | NamedAssetPPtr: Corpse Dream Mage Lord 1/Mage Lord (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets102.assets) |
| Mage Lord | Corpse Dream Mage Lord 1/Mage Lord (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets102.assets) | NamedAssetPPtr: Corpse Dream Mage Lord 1/Mage Lord (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets102.assets) |
...
| childName | "white_light 1" | "white_light 1" |  |  |
| storeResult | [Corpse Dream Mage Lord 1/Mage Lord (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets102.assets)] | [Corpse Dream Mage Lord 1/Mage Lord (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/sharedassets102.assets)] | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Light 2 | OwnerDefault Light 2 |  |  |
| activate | true | true |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Mage Lord | OwnerDefault Mage Lord |  |  |
| activate | true | true |  |  |
| recursive | false | false |  |  |
| resetOnExit | false | false |  |  |
| everyFrame | false | false |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| objectName | "CameraLockArea B" | "CameraLockArea B" |  |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| objectName | "CameraLockArea" | "CameraLockArea" |  |  |
| withTag | "Untagged" | "Untagged" | Tag |  |
| store | GameObject CamLock | GameObject CamLock | Variable |  |
...
| gameObject | OwnerDefault Mage Lord | OwnerDefault Mage Lord |  |  |
| id | "" | "" |  |  |
| vector | Vector3(0, -6.5, 0) | Vector3(0, -6.5, 0) |  |  |
| time | 0f | 0f |  |  |
| delay | 0f | 0f |  |  |
| speed | float Mage Quake Speed | float Mage Quake Speed |  |  |
...
| gameObject | OwnerDefault Mage Lord | OwnerDefault Mage Lord |  |  |
| id | "" | "" |  |  |
| vector | Vector3(2.5, -19.5, 0) | Vector3(2.5, -19.5, 0) |  |  |
| time | 0f | 0f |  |  |
| delay | 0f | 0f |  |  |
| speed | float Mage Quake Speed | float Mage Quake Speed |  |  |
| easeType | iTween/EaseType::linear | 21 |  |  |
...
| --- | --- | --- | --- | --- |
| eventTarget | EventTarget(BroadcastAll):FSM Owner | EventTarget(BroadcastAll):FSM Owner |  |  |
| sendEvent | "MAGE WINDOW BREAK" | "MAGE WINDOW BREAK" |  |  |
| delay | 0f | 0f |  |  |
| everyFrame | false | false |  |  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault Mage Lord | OwnerDefault Mage Lord |  |  |
| clipName | "Tele Out Quick" | "Tele Out Quick" |  |  |
...
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault FSM Owner | OwnerDefault FSM Owner |  |  |
| childName | "GG Death" | "GG Death" |  |  |
| storeResult | GameObject GG Death | GameObject GG Death | Variable |  |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject | OwnerDefault GG Death | OwnerDefault GG Death |  |  |
| activate | true | true |  |  |
| recursive | false | false |  |  |
| resetOnExit | false | false |  |  |
| everyFrame | false | false |  |  |
...
| --- | --- | --- | --- | --- |
| audioPlayer | [Global] [Audio Player Actor (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/resources.assets)] | [Global] [Audio Player Actor (/home/windflower/snap/steam/common/.local/share/Steam/steamapps/common/Hollow Knight/hollow_knight_Data/resources.assets)] |  |  |
| spawnPoint | GameObject GG Death | GameObject GG Death |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Start | FINISHED | Get | 0 | 0 | 0 |
| Get | FINISHED | Mage Lord Up | 0 | 0 | 0 |
| Get | GG BOSS | GG Death | 0 | 0 | 0 |
| Mage Lord Up | FINISHED | Mage Lord Down | 0 | 0 | 0 |
| Mage Lord Down | FINISHED | Break | 0 | 0 | 0 |
| Break | FINISHED | Tele Out | 0 | 0 | 0 |
| Tele Out | FINISHED | End | 0 | 0 | 0 |
| End | FINISHED | Event | 0 | 0 | 0 |
| Start Phase 2 | FINISHED | End | 0 | 0 | 0 |
| GG Death | FINISHED | Start Phase 2 | 0 | 0 | 0 |
