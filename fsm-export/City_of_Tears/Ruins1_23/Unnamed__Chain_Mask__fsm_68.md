...
| float2 | float Mask Y | float Mask Y |  |  |
| tolerance | 0f | 0f |  |  |
| equal | Event() | Event() |  |  |
...
| float2 | float Mask Y | float Mask Y |  |  |
| tolerance | 0f | 0f |  |  |
| equal | Event(UNHIDE) | Event(UNHIDE) |  |  |
| lessThan | Event(UNHIDE) | Event(UNHIDE) |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Init | FINISHED | Visible | 0 | 0 | 0 |
| Visible | HIDE | Invisible | 0 | 0 | 0 |
| Invisible | UNHIDE | Visible | 0 | 0 | 0 |
