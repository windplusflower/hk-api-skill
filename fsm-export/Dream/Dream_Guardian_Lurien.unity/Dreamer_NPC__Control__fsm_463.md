...
| Spawn Max X | 0.75 | Single: 0.75 |
| Spawn Max Y | 1.25 | Single: 1.25 |
| Spawn Min X | -0.75 | Single: -0.75 |
| Spawn Min Y | -1.25 | Single: -1.25 |
| Spawn X | 0 | Single: 0 |
| Spawn Y | 0 | Single: 0 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| PlayerData Bool | lurienDefeated | String: lurienDefeated |
| Return Scene |   | String:  |
...
| delivery | HutongGames.PlayMaker.Actions.SendMessage/MessageType::SendMessage | 0 |   |   |
| options | UnityEngine.SendMessageOptions::DontRequireReceiver | 1 |   |   |
| functionCall |   | StoryRecord_defeated(PlayerData Bool=string PlayerData Bool = "lurienDefeated") |   |   |
