...
| GameObject Path |   |
| Source Asset | Hollow Knight/hollow_knight_Data/level402 |
| Start State | Init |
| FSM PathId | 465 |
...
| Spawn Max X | 0.5 | Single: 0.5 |
| Spawn Max Y | 3 | Single: 3 |
| Spawn Min X | -0.5 | Single: -0.5 |
| Spawn Min Y | -3 | Single: -3 |
| Spawn X | 0 | Single: 0 |
| Spawn Y | 0 | Single: 0 |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| PlayerData Bool | monomonDefeated | String: monomonDefeated |
| Return Scene |   | String:  |
...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Effect Origin | Vector2(0, 1) | Vector2: Vector2(0, 1) |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | [Global] [Dream Get Orb (Hollow Knight/hollow_knight_Data\sharedassets400.assets)] |   |   |
| spawnPoint |   | GameObject Self |   |   |
...
| delivery | HutongGames.PlayMaker.Actions.SendMessage/MessageType::SendMessage | 0 |   |   |
| options | UnityEngine.SendMessageOptions::DontRequireReceiver | 1 |   |   |
| functionCall |   | StoryRecord_defeated(PlayerData Bool=string PlayerData Bool = "monomonDefeated") |   |   |
