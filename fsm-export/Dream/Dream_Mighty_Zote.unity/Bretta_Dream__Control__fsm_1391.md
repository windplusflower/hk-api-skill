...
| animLibName |   | "" |   |   |
| clipName |   | "Bretta Idle" |   |   |

#### Transitions

| Event | To State | Color Index | |
| --- | --- | --- | --- |
| ZOTE ROAR START | Clapping | 0 | |
| ZOTE STUNNED | Shock | 0 | |
| HERO DAMAGED | Damage Clap | 0 | |
...
| gameObject |   | OwnerDefault FSM Owner |   |   |
| animLibName |   | "" |   |   |
| clipName |   | "Bretta Clap" |   |   |

#### Transitions

| Event | To State | Color Index | |
| --- | --- | --- | --- |
| ZOTE ROAR END | Idle | 0 | |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | [Global] [Dream Orb Get Long (Hollow Knight/hollow_knight_Data\sharedassets399.assets)] |   |   |
| spawnPoint |   | GameObject Self |   |   |
