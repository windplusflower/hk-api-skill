...
| Name | Value | Raw/Type |
| --- | --- | --- |
| CamLocks | Dream Gate (1)/CamLocks (Hollow Knight/hollow_knight_Data\level397) | NamedAssetPPtr: [Dream Gate (1)/CamLocks (Hollow Knight/hollow_knight_Data\level397)] |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| gameObject |   | [Dream Gate (1)/CamLocks (Hollow Knight/hollow_knight_Data\level397)] | Variable |   |
| activate |   | false |   |   |
