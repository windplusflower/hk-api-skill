...
| Name | Value | Raw/Type |
| --- | --- | --- |
| Convo Title | INFECTED_KNIGHT_D | String: INFECTED_KNIGHT_D |
...
| Name | Value | RawValue | UIHint | Group |
| --- | --- | --- | --- | --- |
| intVariable |   | int MP Charge | Variable |   |
| intValue |   | 33 |   |   |
| everyFrame |   | false |   |   |
...
| variableName |   | "Convo Amount" | FsmInt |   |
| setValue |   | int Convo Amount |   |   |
| everyFrame |   | false |   |   |
